"use strict";
(globalThis["webpackChunkfptcloud_docs"] = globalThis["webpackChunkfptcloud_docs"] || []).push([[90074],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_fpt_managed_gpu_cluster_worker_storage_add_them_worker_group_md_52c_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-fpt-managed-gpu-cluster-worker-storage-add-them-worker-group-md-52c.json
const site_docs_fpt_managed_gpu_cluster_worker_storage_add_them_worker_group_md_52c_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"fpt-managed-gpu-cluster/worker-storage/add-them-worker-group","title":"2. Managed GPU Cluster (Kubernetes)","description":"Add thêm Worker Group","source":"@site/docs/fpt-managed-gpu-cluster/worker-storage/add-them-worker-group.md","sourceDirName":"fpt-managed-gpu-cluster/worker-storage","slug":"/fpt-managed-gpu-cluster/worker-storage/add-them-worker-group","permalink":"/fpt-managed-gpu-cluster/worker-storage/add-them-worker-group","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"sidebar_label":"Add them worker group","title":"2. Managed GPU Cluster (Kubernetes)","source":"https://fptcloud.com/documents/fpt-managed-gpu-cluster/?doc=add-them-worker-group","parent":"https://fptcloud.com/documents/fpt-managed-gpu-cluster","lang":"vi","converted":"2026-03-19"},"sidebar":"defaultSidebar","previous":{"title":"Worker Group & Storage","permalink":"/fpt-managed-gpu-cluster/worker-storage/"},"next":{"title":"Chinh sua label taint cho worker group managed gpu cluster","permalink":"/fpt-managed-gpu-cluster/worker-storage/chinh-sua-label-taint-cho-worker-group-managed-gpu-cluster"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(28453);
;// ./docs/fpt-managed-gpu-cluster/worker-storage/add-them-worker-group.md
