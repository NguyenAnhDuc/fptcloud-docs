"use strict";
(globalThis["webpackChunkfptcloud_docs"] = globalThis["webpackChunkfptcloud_docs"] || []).push([[4840],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_dedicated_fpt_kubernetes_engine_storage_backup_them_nfs_persistent_storage_md_d1f_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dedicated-fpt-kubernetes-engine-storage-backup-them-nfs-persistent-storage-md-d1f.json
const site_docs_dedicated_fpt_kubernetes_engine_storage_backup_them_nfs_persistent_storage_md_d1f_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dedicated-fpt-kubernetes-engine/storage-backup/them-nfs-persistent-storage","title":"2. Dedicated – FPT Kubernetes Engine","description":"Thêm NFS Persistent Storage","source":"@site/docs/dedicated-fpt-kubernetes-engine/storage-backup/them-nfs-persistent-storage.md","sourceDirName":"dedicated-fpt-kubernetes-engine/storage-backup","slug":"/dedicated-fpt-kubernetes-engine/storage-backup/them-nfs-persistent-storage","permalink":"/dedicated-fpt-kubernetes-engine/storage-backup/them-nfs-persistent-storage","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"sidebar_label":"Them nfs persistent storage","title":"2. Dedicated – FPT Kubernetes Engine","source":"https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=them-nfs-persistent-storage","parent":"https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine","lang":"vi","converted":"2026-03-19"},"sidebar":"defaultSidebar","previous":{"title":"Thay doi flavor cau hinh nodes","permalink":"/dedicated-fpt-kubernetes-engine/storage-backup/thay-doi-flavor-cau-hinh-nodes"},"next":{"title":"Phiên bản & FAQ","permalink":"/dedicated-fpt-kubernetes-engine/version/"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(28453);
;// ./docs/dedicated-fpt-kubernetes-engine/storage-backup/them-nfs-persistent-storage.md
