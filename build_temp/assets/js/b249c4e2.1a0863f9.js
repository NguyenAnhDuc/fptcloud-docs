"use strict";
(globalThis["webpackChunkfptcloud_docs"] = globalThis["webpackChunkfptcloud_docs"] || []).push([[42934],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_fpt_managed_gpu_cluster_worker_storage_chinh_sua_label_taint_cho_worker_group_managed_gpu_cluster_md_b24_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-fpt-managed-gpu-cluster-worker-storage-chinh-sua-label-taint-cho-worker-group-managed-gpu-cluster-md-b24.json
const site_docs_fpt_managed_gpu_cluster_worker_storage_chinh_sua_label_taint_cho_worker_group_managed_gpu_cluster_md_b24_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"fpt-managed-gpu-cluster/worker-storage/chinh-sua-label-taint-cho-worker-group-managed-gpu-cluster","title":"2. Managed GPU Cluster (Kubernetes)","description":"Chỉnh sửa label/taint cho Worker Group","source":"@site/docs/fpt-managed-gpu-cluster/worker-storage/chinh-sua-label-taint-cho-worker-group-managed-gpu-cluster.md","sourceDirName":"fpt-managed-gpu-cluster/worker-storage","slug":"/fpt-managed-gpu-cluster/worker-storage/chinh-sua-label-taint-cho-worker-group-managed-gpu-cluster","permalink":"/fpt-managed-gpu-cluster/worker-storage/chinh-sua-label-taint-cho-worker-group-managed-gpu-cluster","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"sidebar_label":"Chinh sua label taint cho worker group managed gpu cluster","title":"2. Managed GPU Cluster (Kubernetes)","source":"https://fptcloud.com/documents/fpt-managed-gpu-cluster/?doc=chinh-sua-label-taint-cho-worker-group-managed-gpu-cluster","parent":"https://fptcloud.com/documents/fpt-managed-gpu-cluster","lang":"vi","converted":"2026-03-19"},"sidebar":"defaultSidebar","previous":{"title":"Add them worker group","permalink":"/fpt-managed-gpu-cluster/worker-storage/add-them-worker-group"},"next":{"title":"File storage high performance","permalink":"/fpt-managed-gpu-cluster/worker-storage/file-storage-high-performance"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(28453);
;// ./docs/fpt-managed-gpu-cluster/worker-storage/chinh-sua-label-taint-cho-worker-group-managed-gpu-cluster.md
