"use strict";
(globalThis["webpackChunkfptcloud_docs"] = globalThis["webpackChunkfptcloud_docs"] || []).push([[9704],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_managed_fpt_kubernetes_engine_cluster_management_scale_in_chi_dinh_node_md_90f_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-managed-fpt-kubernetes-engine-cluster-management-scale-in-chi-dinh-node-md-90f.json
const site_docs_managed_fpt_kubernetes_engine_cluster_management_scale_in_chi_dinh_node_md_90f_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"managed-fpt-kubernetes-engine/cluster-management/scale-in-chi-dinh-node","title":"2. Managed – FPT Kubernetes Engine","description":"Tính năng scale in chỉ định node trong cluster","source":"@site/docs/managed-fpt-kubernetes-engine/cluster-management/scale-in-chi-dinh-node.md","sourceDirName":"managed-fpt-kubernetes-engine/cluster-management","slug":"/managed-fpt-kubernetes-engine/cluster-management/scale-in-chi-dinh-node","permalink":"/managed-fpt-kubernetes-engine/cluster-management/scale-in-chi-dinh-node","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"sidebar_label":"Scale in chi dinh node","title":"2. Managed – FPT Kubernetes Engine","source":"https://fptcloud.com/documents/managed-fpt-kubernetes-engine/?doc=scale-in-chi-dinh-node","parent":"https://fptcloud.com/documents/managed-fpt-kubernetes-engine","lang":"vi","converted":"2026-03-19"},"sidebar":"defaultSidebar","previous":{"title":"Quan ly kubernetes cluster","permalink":"/managed-fpt-kubernetes-engine/cluster-management/quan-ly-kubernetes-cluster"},"next":{"title":"Thay doi cau hinh k8s cluster","permalink":"/managed-fpt-kubernetes-engine/cluster-management/thay-doi-cau-hinh-k8s-cluster"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(28453);
;// ./docs/managed-fpt-kubernetes-engine/cluster-management/scale-in-chi-dinh-node.md
