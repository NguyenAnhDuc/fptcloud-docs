"use strict";
(globalThis["webpackChunkfptcloud_docs"] = globalThis["webpackChunkfptcloud_docs"] || []).push([[59213],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_managed_fpt_kubernetes_engine_storage_backup_snapshot_persistent_volume_tren_k_8_s_md_9f3_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-managed-fpt-kubernetes-engine-storage-backup-snapshot-persistent-volume-tren-k-8-s-md-9f3.json
const site_docs_managed_fpt_kubernetes_engine_storage_backup_snapshot_persistent_volume_tren_k_8_s_md_9f3_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"managed-fpt-kubernetes-engine/storage-backup/snapshot-persistent-volume-tren-k8s","title":"2. Managed – FPT Kubernetes Engine","description":"Tính năng snapshot Persistent Volume trên kubernetes","source":"@site/docs/managed-fpt-kubernetes-engine/storage-backup/snapshot-persistent-volume-tren-k8s.md","sourceDirName":"managed-fpt-kubernetes-engine/storage-backup","slug":"/managed-fpt-kubernetes-engine/storage-backup/snapshot-persistent-volume-tren-k8s","permalink":"/managed-fpt-kubernetes-engine/storage-backup/snapshot-persistent-volume-tren-k8s","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"sidebar_label":"Snapshot persistent volume tren k8s","title":"2. Managed – FPT Kubernetes Engine","source":"https://fptcloud.com/documents/managed-fpt-kubernetes-engine/?doc=snapshot-persistent-volume-tren-k8s","parent":"https://fptcloud.com/documents/managed-fpt-kubernetes-engine","lang":"vi","converted":"2026-03-19"},"sidebar":"defaultSidebar","previous":{"title":"Restore persistent volume tren k8s","permalink":"/managed-fpt-kubernetes-engine/storage-backup/restore-persistent-volume-tren-k8s"},"next":{"title":"Snapshot v restore pvc tr n k8s fpt","permalink":"/managed-fpt-kubernetes-engine/storage-backup/snapshot-v-restore-pvc-tr-n-k8s-fpt"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(28453);
;// ./docs/managed-fpt-kubernetes-engine/storage-backup/snapshot-persistent-volume-tren-k8s.md
