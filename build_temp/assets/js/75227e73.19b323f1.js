"use strict";
(globalThis["webpackChunkfptcloud_docs"] = globalThis["webpackChunkfptcloud_docs"] || []).push([[58501],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_managed_fpt_kubernetes_engine_worker_group_chinh_sua_label_taint_cho_worker_group_md_752_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-managed-fpt-kubernetes-engine-worker-group-chinh-sua-label-taint-cho-worker-group-md-752.json
const site_docs_managed_fpt_kubernetes_engine_worker_group_chinh_sua_label_taint_cho_worker_group_md_752_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"managed-fpt-kubernetes-engine/worker-group/chinh-sua-label-taint-cho-worker-group","title":"2. Managed – FPT Kubernetes Engine","description":"Chỉnh sửa label/taint cho worker group","source":"@site/docs/managed-fpt-kubernetes-engine/worker-group/chinh-sua-label-taint-cho-worker-group.md","sourceDirName":"managed-fpt-kubernetes-engine/worker-group","slug":"/managed-fpt-kubernetes-engine/worker-group/chinh-sua-label-taint-cho-worker-group","permalink":"/managed-fpt-kubernetes-engine/worker-group/chinh-sua-label-taint-cho-worker-group","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"sidebar_label":"Chinh sua label taint cho worker group","title":"2. Managed – FPT Kubernetes Engine","source":"https://fptcloud.com/documents/managed-fpt-kubernetes-engine/?doc=chinh-sua-label-taint-cho-worker-group","parent":"https://fptcloud.com/documents/managed-fpt-kubernetes-engine","lang":"vi","converted":"2026-03-19"},"sidebar":"defaultSidebar","previous":{"title":"Bat tat node auto repair","permalink":"/managed-fpt-kubernetes-engine/worker-group/bat-tat-node-auto-repair"},"next":{"title":"Chuyen worker group base","permalink":"/managed-fpt-kubernetes-engine/worker-group/chuyen-worker-group-base"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(28453);
;// ./docs/managed-fpt-kubernetes-engine/worker-group/chinh-sua-label-taint-cho-worker-group.md
