"use strict";
(globalThis["webpackChunkfptcloud_docs"] = globalThis["webpackChunkfptcloud_docs"] || []).push([[53295],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_fpt_managed_gpu_cluster_worker_storage_trien_khai_ung_dung_tren_worker_managed_gpu_cluster_md_010_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-fpt-managed-gpu-cluster-worker-storage-trien-khai-ung-dung-tren-worker-managed-gpu-cluster-md-010.json
const site_docs_fpt_managed_gpu_cluster_worker_storage_trien_khai_ung_dung_tren_worker_managed_gpu_cluster_md_010_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"fpt-managed-gpu-cluster/worker-storage/trien-khai-ung-dung-tren-worker-managed-gpu-cluster","title":"2. Managed GPU Cluster (Kubernetes)","description":"Triển khai mô hình DeepSeek-R1 sử dụng Ollama và Open WebUI","source":"@site/docs/fpt-managed-gpu-cluster/worker-storage/trien-khai-ung-dung-tren-worker-managed-gpu-cluster.md","sourceDirName":"fpt-managed-gpu-cluster/worker-storage","slug":"/fpt-managed-gpu-cluster/worker-storage/trien-khai-ung-dung-tren-worker-managed-gpu-cluster","permalink":"/fpt-managed-gpu-cluster/worker-storage/trien-khai-ung-dung-tren-worker-managed-gpu-cluster","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"sidebar_label":"Trien khai ung dung tren worker managed gpu cluster","title":"2. Managed GPU Cluster (Kubernetes)","source":"https://fptcloud.com/documents/fpt-managed-gpu-cluster/?doc=trien-khai-ung-dung-tren-worker-managed-gpu-cluster","parent":"https://fptcloud.com/documents/fpt-managed-gpu-cluster","lang":"vi","converted":"2026-03-19"},"sidebar":"defaultSidebar","previous":{"title":"Tinh nang manual scale managed gpu cluster","permalink":"/fpt-managed-gpu-cluster/worker-storage/tinh-nang-manual-scale-managed-gpu-cluster"},"next":{"title":"GPU & Workloads","permalink":"/fpt-managed-gpu-cluster/gpu-workload/"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(28453);
;// ./docs/fpt-managed-gpu-cluster/worker-storage/trien-khai-ung-dung-tren-worker-managed-gpu-cluster.md
