...
## Concepts 
  ...
  * [ Version database engine ](./database-engine-version)
    * [ Chính sách version ](./version-policy)
    * [ Danh mục version hỗ trợ ](./version-list)
  * [ Mô hình triển khai ](./deployment-model)
  * [ Kết nối mạng và khả năng truy cập ](./network-connectivity)
  * [ Bảo trì dịch vụ ](./maintenance)

## Thiết lập ban đầu (Initial Setup) 

  * [ Yêu cầu thiết lập ban đầu ](./initial-setup)
  * [ Truy cập FPT Console Portal ](./login-console)
  * [ Đăng ký tài khoản FPT Console Portal ](./register-account)
  * [ Quyền truy cập dịch vụ FPT Database Engine ](./iam)
    * [ Quản lý Role ](./role-management)
    * [ Quản lý User Group ](./user-group-management)
  * [ Quản lý Subnet ](./subnet)

## Hướng dẫn chi tiết 

  * [ Quản lý dịch vụ FPT Database Engine ](./db-engine-service)
    * [ Kích hoạt dịch vụ FPT Database Engine ](./active-db-service)
    * [ Huỷ kích hoạt dịch vụ FPT Database Engine ](./deactive-db-service)
  * [ Khởi tạo và vận hành cơ sở dữ liệu ](./db-manage-operate)
    * [ Xem danh sách cơ sở dữ liệu ](./view-db-list)
    * [ Khởi tạo cơ sở dữ liệu ](./create-db)
    * [ Xem thông tin cơ sở dữ liệu ](./db-view-detail)
    * [ Kết nối cơ sở dữ liệu ](./db-connect)
    * [ Vận hành cơ sở dữ liệu ](./db-operation)
    * [ Nâng cấp phiên bản cho cơ sở dữ liệu ](./upgrade-version)
  * [ Backup & Restore ](./backup-restore)
    * [ Quản lý dịch vụ Backup ](./backup-mgmt)
    * [ Quản lý Job Backup ](./backup-job-mgmt)
    * [ Bật/tắt PITR ](./on-off-pitr)
    * [ Khôi phục cơ sở dữ liệu ](./restore-db)
    * [ Đẩy dữ liệu backup lên S3 ](./push-s3)
  * [ Quản lý tài nguyên cụm cơ sở dữ liệu ](./resource)
  * [ Quản lý Parameter ](./parameter)
  * [ Apache Kafka - Quản lý Kafka ACL ](./kafka-user)
  * [ DB Proxy ](./db-proxy)
  ...
  * [ Event Logs ](./log)
  * [ Reporting ](./reporting)
    * [ Xuất báo cáo thủ công (Report Export) ](./report-export)
    * [ Lập lịch báo cáo tự động (Report Schedule) ](./report-schedule)

## Peformance & Benchmark 

  * [ Kết quả Benchmark Sysbench ](./benchmark-sysbench)
...
## Các câu hỏi thường gặp (FAQs) 
  ...
  * [ Migration cho SQL Server ](./migration-cho-sqlserver)
