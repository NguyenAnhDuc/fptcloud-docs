...
This section focus on show up the actual use case of FPT Cloud Iac by using terraform to deploy new Web Application on FPT Cloud, the step described as the following:
  ...
  * The result of terraform CLI: ![file](/img/docs/3c9f7ced88ee-image-1702440353764.png)

  * Acces the floating IP and enjoy the result of `webapp` ![file](/img/docs/4b51f2bf9b70-image-1702440375843.png)
