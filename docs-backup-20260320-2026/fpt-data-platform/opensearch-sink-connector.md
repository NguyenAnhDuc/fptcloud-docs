...
**Bước 3:** Tại màn detail **CDC service** > Chọn tab **Connectors** > nhấn **Create a connector** ![image-1](/img/docs/e90bee4ebe9b-sink-OpenSearch-1.png)
...
Chú ý: Tên connector có thể chứa các kí tự chữ cái thường a-z hoặc các kí tự số 0-9. Đặc biệt không dùng dấu cách có thể thay dấu cách bằng dấu “-”. 
  ...
  * **Database** (required): chọn **OpenSearch** ![image-2](/img/docs/4a59ee18eb06-sink-OpenSearch-2.png)
...
Nhập các thông tin sau:
  ...
  * Trường hợp chọn **From FPT Database Engine** \- Điền các thông tin sau:
    ...
    * **Topics** : Danh sách các topics ![image-3](/img/docs/a0b436f4df5c-sink-OpenSearch-3.png)
  ...
  * Trường hợp chọn **From FPT Database Engine** \- Điền các thông tin sau:
    ...
    * **Topics** : Danh sách các topics ![image-4](/img/docs/7a2e4eeffb24-sink-OpenSearch-4.png)
...
Chú ý nếu người dùng muốn tạo bảo bảng mới thì enable nút create new table 
  ...
  * **Mode (required):** Hành vi của Connector khi không thể xử lý được message 
    ...
    * **All** : Các message lỗi sẽ được gửi vào topic được nhập ![image-5](/img/docs/c33ca2628d0a-sink-OpenSearch-5.png)

**Bước 7:** Nhấn **Next** để chuyển qua màn **Review** ![image-6](/img/docs/38aa476c1500-sink-OpenSearch-6.png)

**Bước 8:** Kiểm tra thông tin sau đó nhấn **Create** để hoàn thành việc tạo connector ![image-7](/img/docs/b065b7f64581-sink-OpenSearch-7.png)

[ Previous 2.9 PostgreSQL Sink Connector ](./postgresql-sink-connector) [ Next 2.11 SQL Server Sink Connector ](./sql-server-sink-connector)
