...
![Userguide FPT Cloud Server 2022 28](/img/docs/6638a5962216-Userguide-FPT-Cloud-Server-2022-28.png)
...
![Userguide FPT Cloud Server 2022 29](/img/docs/5490201f5aa4-Userguide-FPT-Cloud-Server-2022-29-1024x373.png)
...
![file](/img/docs/cdf8c2ce09e1-image-1744794012514.png)
...
![Userguide FPT Cloud Server 2022 32](/img/docs/88cbc1e00732-Userguide-FPT-Cloud-Server-2022-32.png)
...
![Userguide FPT Cloud Server 2022 33](/img/docs/bf7c47a34c96-Userguide-FPT-Cloud-Server-2022-33.png)
...
![Userguide FPT Cloud Server 2022 34](/img/docs/2185365df70a-Userguide-FPT-Cloud-Server-2022-34.png)

Đã kết nối thành công vào máy chủ bằng SSH client.

![Userguide FPT Cloud Server 2022 35](/img/docs/35e7f42ab901-Userguide-FPT-Cloud-Server-2022-35.png)
...
[ Previous Kết nối vào máy ảo Windows ](./tutorials-ket-noi-vao-may-ao-windows) [ Next Gắn thêm card mạng (NIC) vào máy ảo ](./attach-a-network-card-to-the-virtual-machine)
