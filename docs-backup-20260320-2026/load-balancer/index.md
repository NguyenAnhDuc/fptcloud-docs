...
## Load Balancer (Tutorials) 
  ...
  * [ Quản lý Load Balancer ](./quan-ly-load-balancer)
    * [ Khởi tạo Load Balancer ](./khoi-tao-load-balancer)
    * [ Update Load Balancer ](./cap-nhat-load-balancer)
    * [ Theo dõi biểu đồ giám sát Load Balancer ](./theo-doi-bieu-do-load-balancer)
    * [ Thêm External member cho Load Balancer ](./them-external-member)
    * [ Resize cho Load Balancer ](./resize-load-balancer)
    * [ Access logs cho Load balancer ](./access-logs)
    * [ Tích hợp Metric/Access logs Load Balancer với FPT Monitoring (FMON) ](./tich-hop-fmon)
  * [ Quản lý Listener ](./quan-ly-listener)
    * [ Khởi tạo Listener ](./khoi-tao-listener)
    * [ Cấu hình Timeout ](./cau-hinh-timeout)
    * [ Cấu hình L7 policy cho Listener ](./chinh-sua-listener)
    * [ Cấu hình redirect HTTP request sang HTTPS ](./redirect-http-request-sang-https)
    * [ Redirect prefix ](./redirect-prefix)
    * [ Enable HSTS to HTTPS Listener ](./enable-hsts-to-http-listener)
    * [ Cấu hình Allow IP/CIDR ](./allow-ip-cidr)
    * [ Cấu hình SNI trên Load balancer ](./sni-load-balancer)
  * [ Quản lý Server Pool ](./quan-ly-server-pool)
    * [ Khởi tạo Server Pool ](./khoi-tao-server-pool)
    * [ Thêm/bớt member cho Server pool ](./them-bot-member-cho-server-pool)
    * [ Chỉnh sửa cấu hình Health check ](./chinh-sua-cau-hinh-health-check)
  * [ Quản lý SSL Certificate ](./quan-ly-ssl-certificate)
    * [ Import SSL Certificate cho Load Balancer ](./import-ssl-certificate-cho-load-balancer)
    * [ Xoá SSL Certificate ](./xoa-ssl-certificate)

## Classic Load Balancer (Tutorials) 

  * [ Quản lý Load Balancer ](./manage-load-balancer)
    * [ Khởi tạo một Load Balancer mới ](./khoi-tao-mot-load-balancer-moi)
    * [ Thêm máy ảo vào Load Balancer ](./them-may-ao-vao-load-balancer)
    * [ Xóa máy ảo khỏi Load Balancer ](./xoa-may-ao-khoi-load-balancer)
    * [ Thay đổi thông tin cấu hình Load Balancer ](./thay-doi-thong-tin-cau-hinh-load-balancer)
    * [ Xóa Load Balancer ](./xoa-load-balancer)
  * [ Quản lý chứng chỉ SSL cho Load Balancer ](./ssl-load-balancer)
    * [ Tạo/Import SSL Certificate ](./tao-import-ssl-certificate)
    * [ Xem thông tin chi tiết SSL Certificate ](./xem-thong-tin-chi-tiet-ssl-certificate)
