...
## Hướng dẫn chi tiết (Tutorials) 
  ...
  * [ Kích hoạt dịch vụ FPT Container Registry ](./kich-hoat-dich-vu-fpt-container-registry)
    * [ Kiểm tra thông tin gói dịch vụ ](./kiem-tra-thong-tin-goi-dich-vu)
    * [ Kích hoạt dịch vụ ](./kich-hoat-dich-vu)
  * [ Hướng dẫn sử dụng trên Docker CLI ](./huong-dan-su-dung-tren-docker-cli)
    * [ Docker Login ](./docker-login)
    * [ Tag và Push image lên FPT Container Registry ](./tag-va-push-image-len-fpt-container-registry)
    * [ Pull docker image từ FPT Container Registry về local ](./pull-docker-image-tu-fpt-container-registry-ve-local)
  * [ Quản lý Repositories trên FPT Portal ](./quan-ly-repositories-tren-fpt-portal)
    * [ Xem danh sách Repositories ](./xem-danh-sach-repositories)
    * [ Xóa Image hoặc Artifact trong Repositories ](./xoa-image-hoac-artifact-trong-repositories)
  * [ Quản lý Retention Rule ](./quan-ly-retention-rule)
    * [ Thêm mới Tag Retention Rule ](./them-moi-tag-retention-rule)
    * [ Quản lý Tag Retention Rule ](./quan-ly-tag-retention-rule)
    * [ Cấu hình lập lịch chạy Retention Rule ](./cau-hinh-lap-lich-chay-retention-rule)
    * [ Quản lý Retention Run ](./quan-ly-retention-run)
  * [ Quản lý Robot Account ](./quan-ly-robot-account)
    * [ Tạo mới Robot Account ](./tao-moi-robot-account)
    * [ Xem danh sách Robot Account ](./xem-danh-sach-robot-account)
    * [ Cập nhật Robot Account ](./cap-nhat-robot-account)
    * [ Disable Robot Account đang sử dụng ](./disable-robot-account-dang-su-dung)
    * [ Enable Robot Account ](./enable-robot-account)
    * [ Xoá một Robot Account ](./xoa-mot-robot-account)
    * [ Refresh Robot Account ](./refresh-robot-account)
    * [ Hướng dẫn sử dụng Robot Account ](./huong-dan-su-dung-robot-account)
  * [ Quản lý Gói dịch vụ ](./quan-ly-goi-dich-vu)
    * [ Xem chi tiết Quota dịch vụ ](./cem-chi-tiet-quota-dich-vu)
    * [ Hướng dẫn nâng gói dịch vụ đang sử dụng ](./huong-dan-nang-goi-dich-vu-dang-su-dung)
  * [ Scan Images ](./scan-image)
    * [ Scan Image ](./scan-image-1)
    * [ Stop Scan ](./stop-scan)
    * [ Quản lý kết quả Scan images ](./quan-ly-ket-qua-scan-images)
