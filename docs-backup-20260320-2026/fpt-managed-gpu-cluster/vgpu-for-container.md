...
**Bước 1** : Cài đặt vGPU scheduler tại phần cài đặt GPU software & chờ cho đến khi trạng thái ready. ![](/img/docs/a0959517f72d-Picture1.1.png)

**Bước 2** : Tại tab worker group GPU, bạn có quyền lựa chọn enable thành phần elastic GPU scheduler trên từng worker group hoặc không. ![](/img/docs/681f58cdeafb-vgpu01.png)
...
![](/img/docs/2b93e9cb87f1-vgpu02.png)
...
![](/img/docs/e18784df15ca-vgpu03.png)
...
**Kết quả** : ![](/img/docs/251fecdbb606-Picture5.5.png)
...
[ Previous Slurm on FPTCloud Managed GPU cluster ](./slurm-on-fpt-cloud) [ Next GPU time sharing ](./gpu-time-sharing)
