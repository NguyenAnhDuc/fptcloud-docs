...
## Pre- requirement 
  ...
  * [ Tạo Security Groups ](./tao-security-groups)
  * [ Tạo Floating IP ](./tạo-floating-ip)
  * [ Tạo Subnets ](./tạo-subnets)
  * [ Phân quyền tính năng Database ](./phan-quyen-tinh-nang-database)
    * [ Roles ](./roles)

## Hướng dẫn chi tiết (Tutorials) 

  * [ Provision Database Engine ](./provision-database-engine)
    * [ Khởi tạo Database Engine ](./khoi-tao-database-engine)
    * [ Thao tác với Database Engine ](./thao-tac-voi-database-engine)
  * [ Quản lý Backups ](./quan-ly-backups)
    * [ Tạo Backups service ](./tao-backups-service)
    * [ Cập nhật và xóa Backup job ](./cap-nhat-va-xoa-backup-job)
    * [ Cập nhật và xóa Backup Service ](./cap-nhat-va-xoa-backup-service)
  * [ Quản lý Restore ](./quan-ly-restore)
  * [ Quản lý Resource ](./quan-ly-resource)
  * [ Quản lý Configuration ](./quan-ly-configuration)
  * [ Quản lý Process Monitoring ](./quan-ly-process-monitoring)
  * [ Quản lý Event Logs ](./quan-ly-event-logs)
  * [ DB Proxy ](./db-proxy)
    * [ Khởi tạo DB Proxy ](./khoi-tao-db-proxy)
    * [ Thao tác với DB Proxy ](./thao-tac-voi-db-proxy)
