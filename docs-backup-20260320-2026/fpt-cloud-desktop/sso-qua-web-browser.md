...
2.Nếu người dùng **truy cập từ URL mặc định của dịch vụ:**
  ...
  * Cần nhập thông tin Authentication Code (thông tin do quản trị viên khách hàng quản lý) (Ví dụ Authentication Code hợp lệ: pil783454741) ![file](/img/docs/f7f3275fb314-image-1768028663933.png)
...
![file](/img/docs/ddc30cb9be6c-image-1768028737250.png)
...
[ Previous Truy cập qua FCDClient mới ](./sso-qua-fcdclient-moi) [ Next Truy cập qua FCDClient cũ (luồng cũ) ](./sso-qua-fcdclient-cu)
