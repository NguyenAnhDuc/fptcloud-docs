...
![](/img/docs/a6c06913e916-Picture33-1.png)

**Bước 2** : Thực hiện tuỳ chỉnh cấu hình mong muốn

![](/img/docs/e7b42635904e-Picture34-1.png)
...
[ Previous Thực hiện rollback app về cấu hình cũ ](./rollback-app-ve-cau-hinh-cu) [ Next Thực hiện uninstall applications nếu muốn xoá bỏ ](./uninstall-applications-neu-muon-xoa-bo)
