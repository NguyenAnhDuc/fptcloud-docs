...
## Hướng dẫn chi tiết (Tutorials) 
  ...
  * [ Sử dụng Object Storage trên FPT Portal ](./tutorials-su-dung-object-storage-tren-fpt-portal)
    * [ Bucket ](./tutorials-bucket)
    * [ Object ](./tutorials-object)
    * [ Permissions ](./tutorials-permissions)
    * [ Bucket Config ](./tutorials-bucket-config)
    * [ Encryption ](./tutorials-encryption)
  * [ Quản lý Access Key ](./tutorials-quan-ly-access-key-cua-object-storage-tren-fpt-portal)
  * [ Quản lý SubUser ](./tutorials-quan-ly-subuser)
  * [ Sử dụng Object Storage trên S3 Browser ](./tutorials-su-dung-object-storage-tren-s3-client)
  * [ Tích hợp FPT Object Storage với các S3-Client ](./tutorials-tich-hop-fpt-object-storage-voi-cac-s3-client)
  * [ SDK API Reference ](./sdk-api-reference)
  * [ Migrate bucket data ](./migrate-bucket-data)

## Các câu hỏi thường gặp (FAQs) 

## Một số gợi ý mẫu (Samples) 

  * [ Sử dụng FPT Object Storage làm media server ](./su-dung-fpt-object-storage-lam-media-server-luu-tru-va-phan-phoi-media-file-cho-websiteweb-application)
  * [ Xây dựng một website tĩnh bằng FPT Object Storage ](./xay-dung-mot-website-tinh-bang-fpt-object-storage)
  * [ Mount bucket thành ổ đĩa trên máy local ](./mount-bucket-thanh-o-dia-tren-may-local)
  * [ Clone dữ liệu giữa hai bucket khác nhau ](./clone-du-lieu-giua-hai-bucket-khac-nhau)
  * [ Phân quyền sử dụng bucket cho các subuser ](./phan-quyen-su-dung-bucket-cho-cac-subuser)
