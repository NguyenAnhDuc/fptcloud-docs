...
source: "https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=version-policy"
...
[ Previous Database Engine Version ](./database-engine-version) [ Next Supported Versions ](./version-list)
