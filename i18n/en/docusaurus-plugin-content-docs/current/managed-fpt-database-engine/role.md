...
source: "https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=role"
...
On the Role Management page, click **Create role**. The **Create New Role** screen will appear as follows: ![](https://fptcloud.com/wp-content/uploads/2024/01/Role-b2.png)
...
![](https://fptcloud.com/wp-content/uploads/2024/01/see-more-permission.png)
...
![](https://fptcloud.com/wp-content/uploads/2024/01/resource-specified-hide-pass.webp)

After entering all required information, select **Create role** to complete the role creation process.

After the role is created successfully, the new role will appear in the management list with the status **Active** and will be ready to be assigned to users. For instructions on assigning permissions, refer to [User Group Management](<https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=user-group>).
...
[ Previous FPT Database Engine Right Management ](./iam) [ Next User Group Management ](./user-group)
