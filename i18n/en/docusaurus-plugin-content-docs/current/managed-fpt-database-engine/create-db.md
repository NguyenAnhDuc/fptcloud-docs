---
sidebar_label: "Provision Database"
title: "Provision Database"
source: "https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=create-db"
...
Access the **Database List** page corresponding to the type of database you wish to create (see section [View Database List](<https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=view-db-list>) for details), select **Create a Database Engine** or **Create** to start provisioning a new database. The **Create new database** page opens and provides configuration options to define and deploy a new database in the FPT Database Engine environment. Provisioning progress includes 3 steps:
...
![](https://fptcloud.com/wp-content/uploads/2024/01/DBaaS_ProvisionDB_step1-1.png)
...
![](https://fptcloud.com/wp-content/uploads/2024/01/create-db-step-2-2.png)
...
To connect to the newly created database, refer to section [Connect to the Database](<https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=db-connect>).

To operate the database, refer to section [Database Operations](<https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=db-connect>).

[ Previous View Database List ](./view-db-list) [ Next View database cluster information ](./db-view-detail)
