...
sidebar_label: "MySQL"
title: "MySQL"
source: "https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=mysql-troubleshooting"
...
[1\. Backup Error: “Please run OPTIMIZE TABLE on all listed tables…”](<https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=mysql-troubleshooting#contentify_1>)

[2\. Server Crash: MySQL crash when using composite indexes on JSON columns](<https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=mysql-troubleshooting#contentify_2>)

[3\. Metadata Lock Storm](<https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=mysql-troubleshooting#contentify_3>)
...
## 75 admin 10.225.65.36:25694 fpt Query 178 Waiting for table metadata lock SELECT COUNT(1) AS `cnt` FROM `user_notifications` `UserNotificationEntity` WHERE ( ((`UserNotificat  
## 77 admin 10.225.65.36:34558 fpt Query 176 Waiting for table metadata lock SELECT COUNT(1) AS `cnt` FROM `user_notifications` `UserNotificationEntity` WHERE ( ((`UserNotificat  
## 78 admin 10.225.65.36:34570 fpt Query 174 Waiting for table metadata lock SELECT COUNT(1) AS `cnt` FROM `user_notifications` `UserNotificationEntity` WHERE ( ((`UserNotificat  
## 83 agent 10.225.65.46:36868 NULL Query 167 Waiting for table metadata lock SELECT table_schema, table_name, column_name, auto_increment,\n CAST(pow(2, case data_type\n  
## 16 admin 10.225.65.36:49646 fpt Query 125 Waiting for table metadata lock SELECT COUNT(1) AS `cnt` FROM `user_notifications` `UserNotificationEntity` WHERE ( ((`UserNotificat  
## 18 admin 10.225.65.36:49652 fpt Query 124 Waiting for table metadata lock SELECT COUNT(1) AS `cnt` FROM `user_notifications` `UserNotificationEntity` WHERE ( ((`UserNotificat  
`
