...
source: "https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=maintenance-window"
...
When creating a new database cluster, users can select a Maintenance Window in the Additional Service configuration step. The system will apply this configuration from the first operational cycle. For details, refer to [Provision Database](<https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=create-db>) section.
...
![](https://fptcloud.com/wp-content/uploads/2024/01/view-maintenance.png)
...
![](https://fptcloud.com/wp-content/uploads/2024/01/update-maintenance-wwindow.png)
...
To configure the list of email recipients, navigate to the Notification tab and update the settings for the Maintenance service. For more information, refer to [Notification](<https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=notification>) section.

[ Previous Vertical Scaling ](./vertical-scaling) [ Next Notification ](./notification)
