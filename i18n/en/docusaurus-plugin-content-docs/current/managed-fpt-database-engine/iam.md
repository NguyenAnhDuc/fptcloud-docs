---
sidebar_label: "FPT Database Engine Right Management"
title: "FPT Database Engine Right Management"
source: "https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=iam"
...
# FPT Database Engine Right Management
...
To configure roles and define user groups, refer to section [Role Management](<https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=role>), and [User Group Management](<https://fptcloud.com/en/documents/managed-fpt-database-engine-2/?doc=user-group>) for detailed instructions.

[ Previous Accessing FPT Console Portal ](./access-console) [ Next Role Management ](./role)
