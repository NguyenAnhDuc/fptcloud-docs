...
![Alt text](https://fptcloud.com/wp-content/uploads/2025/05/Completion-history.png)
...
To export your entire completion history:
  ...
  3. (Optional) Download completion you want to select by clicking the **start** icon and navigate **My picks**


[ Previous Playground ](./playground) [ Next How to Integrate Model? ](./how-to-integrate-model)
