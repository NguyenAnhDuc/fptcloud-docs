...
sidebar_label: "FAQs"
title: "FAQs"
source: "https://fptcloud.com/en/documents/managed-fpt-kubernetes-engine-2/?doc=faqs-mfke"
...
There are several ways to expose your application outside the cluster for customer use. One simple method is to use the [Load Balancer Services](</en/documents/managed-fpt-kubernetes-engine-2/?doc=load-balancer-services>) as instructed.
