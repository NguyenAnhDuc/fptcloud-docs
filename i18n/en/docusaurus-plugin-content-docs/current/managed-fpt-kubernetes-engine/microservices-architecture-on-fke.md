---
sidebar_label: "Micro-services Architecture on FKE"
title: "Micro-services Architecture on FKE"
source: "https://fptcloud.com/en/documents/managed-fpt-kubernetes-engine-2/?doc=microservices-architecture-on-fke"
...
# Micro-services Architecture on FKE


* * *

![](https://fptcloud.com/wp-content/uploads/2023/11/64-1.png)
...
### 10\. Backup:
  ...
  * Set a [Backup Job (Dedicated)](</en/documents/dedicated-fpt-kubernetes-engine-2/?doc=backup-restore-cluster>) as instructed. Users need to perform data backup on PVC (if any). You can back up to a VM and then perform VM backup using the **FPT Cloud Backup & Recovery** solution.
...
[ Next GPU on FPT Cloud ](./gpu-fpt-cloud)
