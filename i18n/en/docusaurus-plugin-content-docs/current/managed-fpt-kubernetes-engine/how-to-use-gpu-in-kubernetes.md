...
source: "https://fptcloud.com/en/documents/managed-fpt-kubernetes-engine-2/?doc=how-to-use-gpu-in-kubernetes"
...
[ Previous Persistent Storage ](./persistent-storage) [ Next Setting up K8s Cluster with GPU ](./setup-k8s-cluster-for-gpu-usage)
