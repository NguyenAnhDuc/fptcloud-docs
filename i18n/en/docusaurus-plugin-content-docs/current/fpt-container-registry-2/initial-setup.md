...
title: "Initial Setup"
source: "https://fptcloud.com/en/documents/fpt-container-registry/?doc=initial-setup"
...
If this is the first time you use the **FPT Container Registry** service, first, double-check that you have completed the following steps:

  * **Create a FPT Cloud account and log in to the FPT Cloud Portal.**


After that is finished, you can proceed to use the **FPT Container Registry** service on FPT Cloud.
