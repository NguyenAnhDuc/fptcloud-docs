...
source: "https://fptcloud.com/en/documents/file-storage-high-performance-2/?doc=mountpoint-management"
...
[ Previous Vietnam Region ](./vietnam-region) [ Next Using File Storage – High Performance on Baremetal (GPU Server) ](./vn-using-file-storage-high-performance-on-baremetal-gpu-server)
