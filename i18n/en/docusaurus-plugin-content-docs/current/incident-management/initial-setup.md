...
title: "Initial Setup"
source: "https://fptcloud.com/en/documents/incident-management-2/?doc=initial-setup"
...
If this is the first time you use the **FPT Monitoring** and/or **Incident Management** service, first, double-check that you have completed the following steps:

  * **Create a FPT Cloud account and log in to the FPT Cloud Portal.**


After that is finished, you can proceed to use the **FPT Monitoring** and/or **Incident Management** service on FPT Cloud.
