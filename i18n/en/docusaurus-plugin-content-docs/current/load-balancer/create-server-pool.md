...
source: "https://fptcloud.com/en/documents/65101/?doc=create-server-pool"
...
[ Previous Manage Server pool ](./manage-server-pool) [ Next Add/Remove member to/from Server Pool ](./add/remove-member)
