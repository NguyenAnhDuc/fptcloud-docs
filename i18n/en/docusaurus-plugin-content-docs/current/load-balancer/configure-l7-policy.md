...
source: "https://fptcloud.com/en/documents/65101/?doc=Configure-l7-policy"
...
[ Previous Configure timeout ](./configure-timeout) [ Next Configure redirect from HTTP requests to HTTPS ](./redirect-http-to-https)
