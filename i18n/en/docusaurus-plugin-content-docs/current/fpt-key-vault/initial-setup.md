...
title: "Initial Setup"
source: "https://fptcloud.com/en/documents/fpt-key-vault-2/?doc=Initial-Setup"
parent: "https://fptcloud.com/en/documents/fpt-key-vault-2"
lang: en
...
If this is the first time you use the **FPT Key Vault** service, first, double-check that you have completed the following steps:

  * **Create a FPT Cloud account and log in to the FPT Cloud Portal.**


After that is finished, you can proceed to use the **FPT Key Vault** service on FPT Cloud.
