...
title: "Initial Setup"
source: "https://fptcloud.com/en/documents/fpt-argocd-2/?doc=Initial-setup"
...
If this is the first time you use the **FPT DevOps** service, first, double-check that you have completed the following steps:

  * **Create a FPT Cloud account and log in to the FPT Cloud Portal.**


After that is finished, you can proceed to use the **FPT DevOps** service on FPT Cloud.
