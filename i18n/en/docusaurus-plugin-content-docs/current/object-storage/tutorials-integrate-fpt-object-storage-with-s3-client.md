---
sidebar_label: "Integrate FPT Object Storage with S3-Client"
title: "Integrate FPT Object Storage with S3-Client"
source: "https://fptcloud.com/en/documents/fpt-object-storage/?doc=tutorials-integrate-fpt-object-storage-with-s3-client"
...
# Integrate FPT Object Storage with S3-Client
...
**Step 2:** Click the **Open Connection** button on the main interface or select **File** -> **Open Connection** from the menu. ![file](https://s3-sgn10.fptcloud.com/image-fptcloud-documention/fpt-object-storage/image-1692698326176.png) **Step 3:** An **Open Connection** dialog will appear. In this dialog, enter the authentication information as follows:
  ...
  * **Secret Key ID:** Secret Key obtained from FPT Portal. ![file](https://s3-sgn10.fptcloud.com/image-fptcloud-documention/fpt-object-storage/image-1692698347523.png) After entering the authentication information, press **Connect** to establish the connection.


Cyberduck will connect to FPT Object Storage using the provided authentication information. Once the connection is successful, the folder structure on FPT Object Storage appears in the Cyberduck window. ![file](https://s3-sgn10.fptcloud.com/image-fptcloud-documention/fpt-object-storage/image-1692698365189.png) From here, you can perform various operations such as uploading, downloading, and managing files directly through the intuitive interface of Cyberduck.
...
**Step 2.** Click on **New Session** to start setting up a new connection. ![file](https://s3-sgn10.fptcloud.com/image-fptcloud-documention/fpt-object-storage/image-1692698404134.png) **Step 3.** In the **Login** window, follow these steps:
  ...
  * **Port number:** 443\. ![file](https://s3-sgn10.fptcloud.com/image-fptcloud-documention/fpt-object-storage/image-1692698415054.png) **Step 4.** Click **Save** to save the configuration and **Login** to establish the connection.
...
[ Previous Using Object Storage on S3 Browser ](./tutorials-using-object-storage-on-s3-browser)
