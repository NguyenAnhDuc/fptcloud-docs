---
sidebar_label: "Using Object Storage on S3 Browser"
title: "Using Object Storage on S3 Browser"
source: "https://fptcloud.com/en/documents/fpt-object-storage/?doc=tutorials-using-object-storage-on-s3-browser"
...
# Using Object Storage on S3 Browser
...
If you need guidance on integrating it with other SDKs or Clients, please refer to the [**Integrating FPT Object Storage with S3-Clients**](https://fptcloud.com/documents/object-storage/?doc=tutorials-tich-hop-fpt-object-storage-voi-cac-s3-client) section.
...
![User guide FPT Object Storage 16](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-16.png)

**Step 2:** Enter the prepared information in the **Add New Account** popup. Select **Add new account**.

![User guide FPT Object Storage 17](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-17.png)

After a successful connection, the application will display a list of all the **Buckets** in your storage.

![User guide FPT Object Storage 18](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-18.png)

## Creating a New Bucket

**Step 1:** In the **S3 Browser** interface, select **New bucket**.

![User guide FPT Object Storage 19](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-19.png)

**Step 2:** Enter the name of the new bucket and select **Create new bucket**.

![User guide FPT Object Storage 20](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-20.png)

## Uploading Files/Folders to a Bucket

**Step 1:** Navigate to where you want to upload a File/Folder and select **Upload**.

![User guide FPT Object Storage 21](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-21.png)

**Step 2:** Choose either **Upload file** or **Upload folder**.

![User guide FPT Object Storage 22](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-22.png)

**Step 3:** Select the File/Folder from your local storage to upload it to the S3 bucket.

![User guide FPT Object Storage 23](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-23.png)

After a successful upload, the File/Folder will be displayed in **S3 Browser**.

![User guide FPT Object Storage 24](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-24.png)
...
![User guide FPT Object Storage 25](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-25.png)
...
![User guide FPT Object Storage 26](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-26.png)
...
![User guide FPT Object Storage 27](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-27.png)

**Step 2:** Tick the box for **Enable versioning for new-bucket** and select **OK** to save the settings.

![User guide FPT Object Storage 28](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-28.png)
...
![User guide FPT Object Storage 29](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-29.png)

The file will be restored.

![User guide FPT Object Storage 30](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-30.png)
...
![User guide FPT Object Storage 31](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-31.png)

**Step 2:** Select **Add** in the **Bucket Lifecycle Rules** popup to add a new rule.

![User guide FPT Object Storage 32](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-32-1024x697.png)
...
![User guide FPT Object Storage 33](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-33.png)
...
![User guide FPT Object Storage 34](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-34.png)

**Step 5:** Enter the number of days or a specific date, depending on the deletion mode, and select **Add new rule**.

![User guide FPT Object Storage 35](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-35.png)

**Step 6:** Add more rules if needed, and once you have set up all the rules, select **Save**.

![User guide FPT Object Storage 36](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-36-1024x472.png)
...
![User guide FPT Object Storage 37](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-37.png)
...
![User guide FPT Object Storage 38](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-38.png)
...
![User guide FPT Object Storage 39](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-39.png)

**Step 2:** Select the bucket you want to use as a static website and choose **Edit Website Configuration**.

![User guide FPT Object Storage 40](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-40.png)
...
![User guide FPT Object Storage 41](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-41.png)

**Step 4:** Select **Permissions** and set Read permissions for all users for the bucket.

![User guide FPT Object Storage 42](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-42.png)
...
![User guide FPT Object Storage 43](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-43.png)
...
![User guide FPT Object Storage 44](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-44.png)

![User guide FPT Object Storage 45](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-45-1024x538.png)

You can verify that the link becomes inaccessible after the expiration time.

![User guide FPT Object Storage 46](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-46-1024x538.png)

## CORS (Cross-Origin Resource Sharing)

**Step 1:** Access the **CORS Configuration** in **S3 Browser**.

![User guide FPT Object Storage 47](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-47.png)
...
![User guide FPT Object Storage 48](https://fptcloud.com/wp-content/uploads/2022/10/User-guide-FPT-Object-Storage-48.png)

[ Previous Subuser Management ](./tutorials-subuser-management) [ Next Integrate FPT Object Storage with S3-Client ](./tutorials-integrate-fpt-object-storage-with-s3-client)
