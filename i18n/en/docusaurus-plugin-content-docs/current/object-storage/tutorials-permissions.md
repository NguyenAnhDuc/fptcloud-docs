...
title: "Permissions"
source: "https://fptcloud.com/en/documents/fpt-object-storage/?doc=tutorials-permissions"
...
![file](https://s3-sgn10.fptcloud.com/image-fptcloud-documention/fpt-object-storage/image-1690858053759.png)

**Step 3:** Select the display mode in the **Read permission** box, then choose **Update.**

![file](https://s3-sgn10.fptcloud.com/image-fptcloud-documention/fpt-object-storage/image-1690858061046.png)
...
![file](https://s3-sgn10.fptcloud.com/image-fptcloud-documention/fpt-object-storage/image-1690878437407.png)
...
**Bucket Policy is a powerful tool for managing access permissions to data within a bucket. However, it's essential to be cautious when configuring bucket policies to ensure that only authorized users can access data within the bucket.**
    ...
    > - Bucket Policy takes precedence over Object ACL. For security, you should be careful when using both permission layers simultaneously.
...
**Step 2:** Enter a valid policy in the Editor and choose **Save**. ![file](https://s3-sgn10.fptcloud.com/image-fptcloud-documention/fpt-object-storage/image-1690878422700.png)

[ Previous Object ](./tutorials-object) [ Next Bucket Config ](./tutorials-bucket-config)
