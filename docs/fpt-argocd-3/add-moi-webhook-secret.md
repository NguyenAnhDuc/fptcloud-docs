...
![](/img/docs/acd9722c6f9e-Picture68.png)

**Bước 2** : Nhập các thông tin: 

**Secret (required)** : Secret để thực hiện cấu hình webhook tới gitlab/github/bitbucket/… 

![](/img/docs/0fd8a491239c-Picture69.png)

**Bước 3** : Nhấn **Create** để hoàn thành 

![](/img/docs/3559a52718e2-Picture70.png)

[ Previous Cấu hình webhook  ](./cau-hinh-webhook) [ Next Edit webhook Secret  ](./edit-webhook-secret)
