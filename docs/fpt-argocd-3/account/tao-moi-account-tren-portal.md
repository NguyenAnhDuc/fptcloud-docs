...
![](/img/docs/3e8fefb9f3d1-Picture81.png)
...
![](/img/docs/56c3dcc02dc2-Picture82.png)

  * **Bước 3** : Click button **Add** để thực hiện tạo mới account

![](/img/docs/c343b464d46a-Picture83.png)

  * **Bước 4** : Kiểm tra kết quả account đã được tạo mới trên ArgoCD

![](/img/docs/3375cc1dc39d-Picture84.png)

[ Previous Quản lý account trên argocd ](./quan-ly-account-tren-argocd) [ Next Edit capabilities ](./edit-capabilities)
