...
![](/img/docs/fddde53e0331-Picture79.png)

**Bước 2** : Thực hiện chọn version muốn upgrade:

![](/img/docs/1a5785f9027d-Picture80.png)

**Bước 3** : Nhấn **Update** để thực hiện Upgrade version

[ Previous Nâng gói dịch vụ đang sử dụng ](./nang-goi-dich-vu-dang-su-dung) [ Next Quản lý account trên argocd ](./quan-ly-account-tren-argocd)
