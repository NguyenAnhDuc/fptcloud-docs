...
✨ Hướng dẫn manual scale in/scale out trên portal console: tham khảo user guide [tại đây](<https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=manual-scale>)
...
3️⃣ **Khi tiến trình bị timeout**
  ...
  * Có thể nhấn action retry để thực hiện quá trình lại một lần nữa. Chi tiết có hướng dẫn [tại đây](<https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=retry-timeout-rule>)

[ Previous Manual Scaling ](./manual-scale) [ Next Persistent Storage ](./persistent-storage)
