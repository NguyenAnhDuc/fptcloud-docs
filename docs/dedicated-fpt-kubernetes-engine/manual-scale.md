...
**Bước 4** : Kiểm tra lại thông tin, chọn Scale Cluster để thực hiện scale Worker. ![](/img/docs/e979a99051df-anh3.png)

![](/img/docs/88f304e71890-anh44.png)
...
[ Previous Automatic Scaling ](./autoscale) [ Next Best Practice Manual Scaling ](./best-practice-manual-scaling)
