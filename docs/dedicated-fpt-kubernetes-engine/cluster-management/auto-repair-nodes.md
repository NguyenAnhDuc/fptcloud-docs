...
Tại configmap “auto-repair-configmap" trong namespace kubesystem, có hai trường bạn có thể chỉnh sửa:
    ...
    enable_rebooting_node (mặc định "true") 
...
[ Previous Best Practice Upgrade FKE Cluster Version ](./best-practice-upgrade-fke-cluster-version) [ Next Retry – Timeout Rule ](./retry-timeout-rule)
