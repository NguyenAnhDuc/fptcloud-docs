...
Trong đó "ACCESS_KEY_ID", "SECRET_KEY_ID" và "ENDPOINT" được lấy từ FPT Unify Portal theo hướng dẫn tại [link này](<https://fptcloud.com/documents/object-storage/?doc=tutorials-quan-ly-access-key-cua-object-storage-tren-fpt-portal>).
...
[ Previous Tích hợp FPT Object Storage với các S3-Client ](./tutorials-tich-hop-fpt-object-storage-voi-cac-s3-client) [ Next Migrate bucket data ](./migrate-bucket-data)
