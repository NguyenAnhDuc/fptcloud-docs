...
Nếu bạn cần hướng dẫn tích hợp vào các SDK hoặc Client khác, hãy tham khảo phần [**Tích hợp FPT Object Storage với các S3-Client.**](https://fptcloud.com/documents/object-storage/?doc=tutorials-tich-hop-fpt-object-storage-voi-cac-s3-client)
...
![User guide FPT Object Storage 16](/img/docs/5946a0ca41e5-User-guide-FPT-Object-Storage-16.png) **Bước 2:** Nhập các thông tin đã chuẩn bị vào popup **Add New Account**. Chọn **Add new account**.

![User guide FPT Object Storage 17](/img/docs/ebb112eab496-User-guide-FPT-Object-Storage-17.png)

Sau khi kết nối thành công ứng dụng sẽ hiển thị danh sách toàn bộ **Bucket** trong Storage của bạn.

![User guide FPT Object Storage 18](/img/docs/d232f82dffe0-User-guide-FPT-Object-Storage-18.png)

## Tạo Bucket mới

**Bước 1** : Ở giao diện **S3 Browser** , chọn **New bucket.**

![User guide FPT Object Storage 19](/img/docs/6d6ada0b5eff-User-guide-FPT-Object-Storage-19.png)

**Bước 2:** Nhập tên bucket mới và chọn **Create new bucket**.

![User guide FPT Object Storage 20](/img/docs/8b2e049ce500-User-guide-FPT-Object-Storage-20.png)

## Upload File/Folder vào bucket

**Bước 1** : Di chuyển đến vị trị cần upload File/Folder và chọn **Upload**.

![User guide FPT Object Storage 21](/img/docs/b64dc3512ae5-User-guide-FPT-Object-Storage-21.png)

**Bước 2:** Chọn tùy chọn **Upload file** hoặc **Upload folder**.

![User guide FPT Object Storage 22](/img/docs/ee46882a2f2b-User-guide-FPT-Object-Storage-22.png)

**Bước 3:** Chọn File/Folder từ local để tiến hành upload lên S3 bucket.

![User guide FPT Object Storage 23](/img/docs/715159a2eb86-User-guide-FPT-Object-Storage-23.png)

Sau khi upload thành công, File/Folder sẽ được hiển thị trên **S3 Browser**.

![User guide FPT Object Storage 24](/img/docs/11eea5f09bbd-User-guide-FPT-Object-Storage-24.png)

## Download File/Folder từ bucket

**Bước 1:** Chọn File/Folder cần download trên danh sách, chọn **Download**.

![User guide FPT Object Storage 25](/img/docs/bc174a186193-User-guide-FPT-Object-Storage-25.png)

**Bước 2:** Chọn thư mục ở máy local để lưu **File/Folder** tải về từ S3 bucket > Chọn **Select Folder** để xác nhận.

![User guide FPT Object Storage 26](/img/docs/dbef0261213c-User-guide-FPT-Object-Storage-26.png)
...
![User guide FPT Object Storage 27](/img/docs/29308078386d-User-guide-FPT-Object-Storage-27.png)

**Bước 2:** Tick chọn **Enable versioning for new-bucket** và chọn **OK** để lưu cài đặt.

![User guide FPT Object Storage 28](/img/docs/2a0c389a62b5-User-guide-FPT-Object-Storage-28.png)
...
![User guide FPT Object Storage 29](/img/docs/6f9195da8011-User-guide-FPT-Object-Storage-29.png)

File đã được khôi phục trở lại.

![User guide FPT Object Storage 30](/img/docs/3bc28457ab87-User-guide-FPT-Object-Storage-30.png)
...
![User guide FPT Object Storage 31](/img/docs/efabe217ce38-User-guide-FPT-Object-Storage-31.png)

**Bước 2:** Chọn **Add** ở popup **Bucket Lifecycle Rules** để thêm Rule mới:

![User guide FPT Object Storage 32](/img/docs/2cf671809ee6-User-guide-FPT-Object-Storage-32-1024x697.png)
...
![User guide FPT Object Storage 33](/img/docs/57db54f036df-User-guide-FPT-Object-Storage-33.png)

**Bước 3:** Chọn chế độ xóa:

  * **After specific number of days after creation:** Các file sẽ bị xóa sau một số ngày nhất định.
  * **On a particular date (UTC Midnight**): Các file sẽ bị xóa tại ngày cụ thể (Tính theo thời gian UTC).![User guide FPT Object Storage 34](/img/docs/b83c13b0ca72-User-guide-FPT-Object-Storage-34.png)

**Bước 4:** Nhập số lượng ngày hoặc ngày cụ thể tùy theo chế độ xóa và chọn **Add new rule**.

![User guide FPT Object Storage 35](/img/docs/f158dc30fcd4-User-guide-FPT-Object-Storage-35.png)

**Bước 5:** Thêm các rule khác tương tự. Sau khi đã thiết lập xong toàn bộ rule bạn chọn **Save.**

![User guide FPT Object Storage 36](/img/docs/8379d63a26c2-User-guide-FPT-Object-Storage-36-1024x472.png)
...
![User guide FPT Object Storage 37](/img/docs/51971e9eda40-User-guide-FPT-Object-Storage-37.png)
...
**Bucket ACL** hỗ trợ 3 dạng user cơ bản với các quyền Full Control, Read, Write, Read Permissions và Write Permissions. Khách hàng có thể thao tác nhanh bằng cách chọn một trong hai dạng ACL:
  ...
  * **Make private** : Chỉ có owner có thể thao tác với bucket.![User guide FPT Object Storage 38](/img/docs/c1590c9271fb-User-guide-FPT-Object-Storage-38.png)
...
![User guide FPT Object Storage 39](/img/docs/abc690187e8b-User-guide-FPT-Object-Storage-39.png)

**Bước 2:** Chọn bucket muốn đặt làm Static website > Chọn **Edit Website Configuration.**

![User guide FPT Object Storage 40](/img/docs/2ed8a15306e5-User-guide-FPT-Object-Storage-40.png)
...
![User guide FPT Object Storage 41](/img/docs/a3d5f504d9b1-User-guide-FPT-Object-Storage-41.png)

**Bước 4:** Chọn **Permissions** > Thiết lập quyền Read cho tất cả user đối với bucket.

![User guide FPT Object Storage 42](/img/docs/3a75930698dc-User-guide-FPT-Object-Storage-42.png)
...
![User guide FPT Object Storage 43](/img/docs/c32fd309b275-User-guide-FPT-Object-Storage-43.png)
...
![User guide FPT Object Storage 44](/img/docs/205184e3b92f-User-guide-FPT-Object-Storage-44.png)

![User guide FPT Object Storage 45](/img/docs/08b2a3af78ca-User-guide-FPT-Object-Storage-45-1024x538.png)

Khách hàng có thể kiểm tra sau thời gian expire thì link sẽ hết khả năng truy cập được.

![User guide FPT Object Storage 46](/img/docs/0ae51a518161-User-guide-FPT-Object-Storage-46-1024x538.png)

## CORS (Cross Origin Resource Sharing)

**Bước 1:** Truy cập vào **CORS Configuration** trên **S3 Browser**.

![User guide FPT Object Storage 47](/img/docs/cec0f611f269-User-guide-FPT-Object-Storage-47.png)
...
![User guide FPT Object Storage 48](/img/docs/99ddaff0d035-User-guide-FPT-Object-Storage-48.png)

[ Previous Quản lý SubUser ](./tutorials-quan-ly-subuser) [ Next Tích hợp FPT Object Storage với các S3-Client ](./tutorials-tich-hop-fpt-object-storage-voi-cac-s3-client)
