...
## Hướng dẫn nhanh (Quick Starts) 
  ...
  * [ Tạo một yêu cầu cung cấp tài nguyên ](./create-request-resource)
  * [ Xem các yêu cầu đã tạo ](./view-request-resource)

## Các câu hỏi thường gặp (FAQs) 

  * [ Tôi có thể tạo nhiều yêu cầu cùng 1 lúc được không? ](./fqas-1)
  * [ Làm thế nào để biết FCI đã nhận được yêu cầu của tôi? ](./fqas-2)
  * [ Tôi có thể lựa chọn VPC hoặc tạo mới VPC khi yêu cầu dịch vụ không? ](./fqas-3)
  * [ Vì sao tôi không tìm thấy phần Request Resource ở thành menu? ](./fqas-4)
  * [ Vì sao tôi không thể chọn submit để gửi ticket? ](./fqas-5)
