...
[ Previous Cấu hình proxy protocol cho istio-ingress với Managed Kubernetes cluster  ](./cau-hinh-proxy-protocol-cho-istio-ingress) [ Next Sử dụng service type Loadbalancer Layer 7 (LBv2) ](./service-type-kb-layer7-lbv2)
