...
Thực hiện đặt lịch Snapshot PVC trên Kubernetes
...
[ Previous Tính năng restore volume từ snapshot trên kubernetes ](./restore-persistent-volume-tren-k8s) [ Next Thực hiện đặt lịch xóa Snapshot PVC trên Kubernetes  ](./thuc-hien-dat-lich-xoa-pvc-snapshot)
