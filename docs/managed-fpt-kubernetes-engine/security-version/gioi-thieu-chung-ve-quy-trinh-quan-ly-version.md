...
Giới thiệu chung về quy trình quản lý version Kubernetes trên FPTCloud
...
[ Previous Tính năng tự động nâng cấp phiên bản (Automatic Upgrade Version) ](./tu-dong-nang-cap-version) [ Next Hướng dẫn chi tiết sử dụng tính năng auto upgrade version ](./huong-dan-chi-tiet-su-dung-auto-upgrade)
