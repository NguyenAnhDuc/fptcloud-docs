...
Tính năng Benchmark Managed Kubernetes Cluster
...
![](/img/docs/dcd8247ef2a2-Picture1-7.png)
...
![](/img/docs/7bec9f134d7a-Picture2-5.png)
...
![](/img/docs/f60fafacdbd3-Picture3-5.png)

[ Previous Tính năng tăng cường bảo mật cho dịch vụ MFKE ](./tinh-nang-tang-cuong-bao-mat-mfke) [ Next Tính năng Runtime Security cho Managed Kubernetes Cluster  ](./tinh-nang-runtime-security-cluster)
