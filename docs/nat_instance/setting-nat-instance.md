...
sidebar_label: "Cài đặt Nat instance"
...
![file](/img/docs/32d8b6da3493-image-1719483615596.png)

**Lưu ý: Trường subnet, cần chọn subnet có thể truy cập Internet.**

![file](/img/docs/69d5936434d4-image-1719483627834.png)
...
[ Previous Hướng dẫn về sử dụng Nat instance ](./use-nat-instance)
