---
sidebar_label: "Go to AI Platform → Model Serving → Deployment → Deployment Name → Model Settings"
...
# Detailed Configuration Information for a Deployment
...
![Alt text](https://fptcloud.com/wp-content/uploads/2024/12/12.png) In the Model Settings section, users can modify the configurations of Image Information as follows:
...
[ Previous Status and Actions for a Deployment ](./status-actions-deployment) [ Next Deployment Configuration Information ](./deployment-configuration-information)
