...
![](/img/docs/af2686bc5b38-dblist_nodb-scaled.png)
...
![](/img/docs/a77a8c3ca24e-db-list-warning.png)
...
[ Previous Khởi tạo và vận hành cơ sở dữ liệu ](./db-manage-operate) [ Next Khởi tạo cơ sở dữ liệu ](./create-db)
