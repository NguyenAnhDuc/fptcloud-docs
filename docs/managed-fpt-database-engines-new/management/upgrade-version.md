...
![](/img/docs/4bc6cce270fa-view-upgrade-action-scaled.png)
...
![](/img/docs/9e7d5cfb1398-upgrade-version-mariadb-scaled.png)
...
[ Previous Vận hành cơ sở dữ liệu ](./db-operation) [ Next Backup & Restore ](./backup-restore)
