...
![](/img/docs/ef82702b9970-db-proxy-list-scaled.png)
...
![](/img/docs/edd86c55b1b9-create-db-proxy-scaled.png)
...
![](/img/docs/1adf11c41ba4-view-db-proxy-scaled.png)
...
![](/img/docs/af6165d795f8-db-proxy-action-scaled.png)
...
[ Previous Apache Kafka - Quản lý Kafka ACL ](./kafka-user) [ Next Vertical Scaling ](./vertical-scaling)
