...
![Alt text](/img/docs/11bc300a2c62-overview-scaled.png)
...
![Alt text](/img/docs/ffe6ebc4bbe2-overview-with-warning-popup-scaled.png)
...
[ Previous Khởi tạo cơ sở dữ liệu ](./create-db) [ Next Kết nối cơ sở dữ liệu ](./db-connect)
