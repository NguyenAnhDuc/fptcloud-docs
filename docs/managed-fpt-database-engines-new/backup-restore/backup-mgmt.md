...
![](/img/docs/fb3b9b39fc7b-DBaaS_BackupDB_noti_warning-e1764561851116.png)
...
![](/img/docs/5a5defe2ec02-DBaaS_BackupDB_view_inactive-scaled.png)
...
![](/img/docs/15ed20cd51c9-DBaaS_BackupDB_enable-e1764561767179.png)
...
![Alt text](/img/docs/d646a9780b45-DBaaS_BackupDB_edit_popup-e1764562966549.png)
...
**Cảnh báo:** Việc huỷ dịch vụ Backup sẽ xóa toàn bộ dữ liệu đã được sao lưu, đồng thời hủy tất cả các job backup hiện có. Sau khi xóa, bạn không thể thực hiện restore hoặc khôi phục cơ sở dữ liệu theo thời điểm (PITR).
...
[ Previous Backup & Restore ](./backup-restore) [ Next Quản lý Job Backup ](./backup-job-mgmt)
