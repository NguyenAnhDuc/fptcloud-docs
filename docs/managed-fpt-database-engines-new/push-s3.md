...
![](/img/docs/03d0f2a329d1-migration-list-scaled.png)
...
![](/img/docs/8f6342cf62b5-s3-config-scaled.png)
...
![](/img/docs/44b1a2e5ecc3-DBaaS_BackupDB_restore_list.png)
...
![](/img/docs/a69f73c59f28-push-s3.png)
...
![](/img/docs/0f76689cb560-log-s3.png)
...
![](/img/docs/ab343b8a9f0d-S3-browser.png)

[ Previous Khôi phục cơ sở dữ liệu ](./restore-db) [ Next Quản lý tài nguyên cụm cơ sở dữ liệu ](./resource)
