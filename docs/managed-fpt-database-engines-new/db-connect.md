...
![](/img/docs/8aa5e8ed3c3c-create-security-group-scaled.png)
...
![](/img/docs/65984edf37f0-allocate-IP-scaled.png)
...
![](/img/docs/2357ac75cabb-db-overview-scaled.png)
...
[ Previous Xem thông tin cơ sở dữ liệu ](./db-view-detail) [ Next Vận hành cơ sở dữ liệu ](./db-operation)
