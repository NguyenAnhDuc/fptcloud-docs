...
![](/img/docs/46051a0f8500-create-role.png)
...
![](/img/docs/faeb2c18a714-see-more-permission.png)
...
![](/img/docs/ad74aea0a4d1-resource-specified-hide-pass.webp)

Sau khi nhập đầy đủ thông tin, chọn **Create role** để hoàn tất quá trình tạo role.

Sau khi tạo thành công, role mới sẽ xuất hiện trong danh sách quản lý với trạng thái **Active** và sẵn sàng để cấp quyền cho người dùng. Hướng dẫn cấp quyền vui lòng tham khảo tại mục [Quản lý User Group](<https://fptcloud.com/documents/managed-fpt-database-engines-new/?doc=user-group-management>).
...
[ Previous Quyền truy cập dịch vụ FPT Database Engine ](./iam) [ Next Quản lý User Group ](./user-group-management)
