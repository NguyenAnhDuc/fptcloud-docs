...
Quyền truy cập dịch vụ FPT Database Engine
...
Để cấu hình quyền truy cập và khai báo nhóm người dùng, vui lòng tham khảo chi tiết tại mục [Quản lý Role](<https://fptcloud.com/documents/managed-fpt-database-engines-new/?doc=role-management>) và [Quản lý User Group](<https://fptcloud.com/documents/managed-fpt-database-engines-new/?doc=user-group-management>).

[ Previous Đăng ký tài khoản FPT Console Portal ](./register-account) [ Next Quản lý Role ](./role-management)
