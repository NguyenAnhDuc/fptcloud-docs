...
![](/img/docs/514e908e6894-view-kafka-acl-scaled.png)
...
![](/img/docs/15c4e64f2819-create-kafka-user-scaled.png)
...
![](/img/docs/ee68daae5d2e-grant-acl-scaled.png)
...
[ Previous Quản lý Parameter ](./parameter) [ Next DB Proxy ](./db-proxy)
