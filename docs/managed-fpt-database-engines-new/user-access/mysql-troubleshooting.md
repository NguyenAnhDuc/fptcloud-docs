...
[1\. Backup Error: “Please run OPTIMIZE TABLE on all listed tables…](<https://fptcloud.com/documents/managed-fpt-database-engines-new/?doc=mysql-troubleshooting#contentify_2>)

[2\. Server Crash: Lỗi crash MySQL khi sử dụng combo index trên cột JSON](<https://fptcloud.com/documents/managed-fpt-database-engines-new/?doc=mysql-troubleshooting#contentify_3>)
