...
![](/img/docs/ad13f2c5cb03-deactive-FDE-scaled.png)
...
[ Previous Kích hoạt dịch vụ FPT Database Engine ](./active-db-service) [ Next Khởi tạo và vận hành cơ sở dữ liệu ](./db-manage-operate)
