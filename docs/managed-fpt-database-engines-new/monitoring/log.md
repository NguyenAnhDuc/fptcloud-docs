...
![](/img/docs/85e128b69479-view-process-monitor-scaled.png)

  * Chọn tab “**Event Logs** ” để xem event log.

![](/img/docs/61adb5ff49fe-view-event-log-scaled.png)

[ Previous Monitoring ](./monitoring) [ Next Reporting ](./reporting)
