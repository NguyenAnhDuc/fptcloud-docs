...
Khi tạo mới cluster, người dùng có thể chọn maintenance window tại bước cấu hình **Additional Service** (chi tiết xem tại mục [Khởi tạo cơ sở dữ liệu](<https://fptcloud.com/documents/managed-fpt-database-engines-new/?doc=create-db#contentify_2>)) và hệ thống sẽ áp dụng cấu hình ngay từ lần vận hành đầu tiên.
...
![](/img/docs/3d911f64447c-view-maintenance.png)
...
![](/img/docs/d95e9f425a1b-update-maintenance-wwindow.png)
