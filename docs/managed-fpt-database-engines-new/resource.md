...
![](/img/docs/5cec940faa9d-view-resource-scaled.png)
...
![](/img/docs/002f98f3fa13-update-resource-scaled.png)
...
![](/img/docs/4642a33c3b91-update-storage-policy-1-scaled.png)
...
[ Previous Đẩy dữ liệu backup lên S3 ](./push-s3) [ Next Quản lý Parameter ](./parameter)
