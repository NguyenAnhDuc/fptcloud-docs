...
Để quản lý và vận hành cơ sở dữ liệu, vui lòng tham khảo hướng dẫn chi tiết tại các mục:
  ...
  * [Xem danh sách cơ sở dữ liệu](<https://fptcloud.com/documents/managed-fpt-database-engines-new/?doc=view-db-list>): Hiển thị danh sách các cơ sở dữ liệu bạn có quyền truy cập, bao gồm trạng thái, cấu hình và các thông tin quan trọng.
  * [Khởi tạo cơ sở dữ liệu](<https://fptcloud.com/documents/managed-fpt-database-engines-new/?doc=create-db>): Khởi tạo một cơ sở dữ liệu mới bằng cách lựa chọn hệ quản trị, phiên bản, flavor và các cấu hình cần thiết khác.
  * [Kết nối cơ sở dữ liệu](<https://fptcloud.com/documents/managed-fpt-database-engines-new/?doc=db-connect>): Tìm hiểu cách lấy thông tin kết nối và kết nối tới cơ sở dữ liệu từ ứng dụng hoặc các công cụ client.
  * [Vận hành cơ sở dữ liệu](<https://fptcloud.com/documents/managed-fpt-database-engines-new/?doc=db-operation>): Thực hiện các thao tác vận hành phổ biến như khởi động, dừng, khởi động lại, quản lý cấu hình và theo dõi cơ sở dữ liệu.
...
[ Previous Huỷ kích hoạt dịch vụ FPT Database Engine ](./deactive-db-service) [ Next Xem danh sách cơ sở dữ liệu ](./view-db-list)
