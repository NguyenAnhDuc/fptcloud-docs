...
sidebar_label: "Tao report"
title: "2. FPT Reporting"
source: "https://fptcloud.com/documents/reporting/?doc=tao-report"
...
![](/img/docs/57affdd65bfc-Picture1.png)

**Note: Trong trường hợp người dùng muốn thêm dashboard, click nút “Add another dashboard”**

**Bước 3** : Click nút **Next** ở góc bên phải màn hình để chuyển sang bước tiếp theo **Format report**

![Alt text](/img/docs/c77f7b7d203f-Picture2.png)
...
**Bước 5** : Click nút **Next** để chuyển sang bước tiếp theo **“Schedule”**

![Alt text](/img/docs/ebf2980f7c05-Picture3.png)
...
![Alt text](/img/docs/39f2fc3ee047-Picture4.png)
...
![Alt text](/img/docs/9bf78bbf4c04-Picture5.png)
...
![Alt text](/img/docs/17a6da4e4a39-Picture6.png)
...
![Alt text](/img/docs/fd778276dd37-Picture7.png)
...
![Alt text](/img/docs/8624f2789189-Picture8.png)
...
**Bước 7** : Click nút **Next** ở góc phải màn hình để chuyển sang bước tiếp theo **“Confirm”**

Hiển thị màn hình **Confirm** bao gồm các thông tin phần Select Dashboard, Format Report, Schedule cho người dùng kiểm tra lại.

![Alt text](/img/docs/58d335a3e7e6-Picture9.png)

**Bước 8** : Chọn **Create** để tạo báo cáo 

[ Previous Tích hợp dịch vụ ](./tich-hop-dich-vu) [ Next Test send email  ](./test-send-email)
