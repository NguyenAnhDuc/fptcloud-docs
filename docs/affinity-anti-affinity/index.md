...
## Hướng dẫn nhanh (Quick Starts) 
  ...
  * [ Khởi tạo một Instance Group mới ](./create-instance-group)
  * [ Xóa một Instance Group ](./delete-instance-group)
  * [ Gắn máy ảo vào Instance Group ](./add-instance-instance-group)
