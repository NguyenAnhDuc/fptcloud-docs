...
sidebar_label: "Tao Target"
title: "2. FPT Cloud VA"
source: "https://fptcloud.com/documents/fpt-va/?doc=tao-target"
...
**Bước 1** : Ở menu chọn **Security** > **Cloud VA** , chọn **Create target**. ![file](/img/docs/8b617f0138be-image-1690784417122.png)
    
    
    Lưu ý: Đối với những Tenant chưa được cấp quyền sử dụng dịch vụ sẽ hiển thị thông báo **You do not have sufficient permissions to view this page!**, hãy chọn đúng Tenant đã được cấp quota để sử dụng dịch vụ.
...
![file](/img/docs/e0028c0b66f3-image-1690784465895.png) ![file](/img/docs/f38abd1c3c2a-image-1690784498097.png)
...
![file](/img/docs/5c01dd7652a7-image-1690785093751.png)
...
![file](/img/docs/ddeeca409c60-image-1690785087695.png)

**Bước 3** : Chọn **Create** để khởi tạo. Hệ thống sẽ thông báo xác nhận, kiểm tra tài nguyên và tiến hành xử lý dựa trên các thông tin đã khai báo. ![file](/img/docs/88b11fe4caeb-image-1690785077367.png)
...
[ Previous Quản lý Target ](./quan-ly-target) [ Next 2 Kiểm tra trạng thái scan của Target ](./kiem-tra-trang-thai-target)
