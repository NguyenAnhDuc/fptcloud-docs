...
![file](/img/docs/005669dd0ba4-image-1719821801276.png)
...
![file](/img/docs/d3ebd4bfade9-image-1719821812687.png)

**Bước 3** : Hệ thống sẽ tắt Policy và cập nhật trạng thái từ **Active** sang **Inactive** trên màn hình **Policy Management**

![file](/img/docs/3247e00ed848-image-1719821825580.png)

[ Previous Delete policy ](./delete-policy) [ Next Enable policy ](./enable-policy)
