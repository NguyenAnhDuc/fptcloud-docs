...
Để thực hiện tạo cảnh báo cho dịch vụ VPN đang sử dụng, chọn **Type** là **VPN site-to-site** ![file](/img/docs/d519bebe27ea-image-1759485440087.png) Chọn **Metric Type** , **Apply to** , **Severity** , cấu hình điều kiện cảnh báo tại **Configure Condition** và chọn người nhận cảnh báo tại **Notify to**
...
Nếu chưa có người nhận cho cảnh báo VPN, nhấn Create recipient here để tạo mới người nhận mức VPC như sau: ![file](/img/docs/fa58b299cc19-image-1722328406388.png)
...
[ Previous Khởi tạo cảnh báo cho Load Balancer ](./khoi-tao-canh-bao-load-balancer) [ Next Khởi tạo một Activity Alert mới ](./khoi-tao-mot-alert-moi-activity-alert)
