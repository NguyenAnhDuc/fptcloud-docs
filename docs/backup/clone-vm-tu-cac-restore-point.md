...
### **Bước 1: Mở Quản Lý Backup & Recovery**

  1. Truy cập vào giao diện quản trị của **FPT Backup**.
...
[ Previous Restore lại VM từ các Restore Point  ](./restore-lai-vm-tu-cac-restore-point) [ Next Xem lịch sử Backup & Recovery  ](./xem-lich-su-backup-and-recovery)
