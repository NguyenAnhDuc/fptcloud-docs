...
![Alt text](https://fptcloud.com/wp-content/uploads/2025/02/Base-Model.png)
...
[ Previous How to Create Pipeline? ](./how-to-create-pipeline) [ Next Select Trainer ](./select-trainer)
