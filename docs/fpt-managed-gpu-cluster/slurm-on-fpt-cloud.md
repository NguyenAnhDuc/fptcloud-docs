...
sidebar_label: "Slurm on FPTCloud Managed GPU cluster"
...
![](/img/docs/00c51d67dcc4-Picture1-1.png)
...
![](/img/docs/d68031fc1434-Picture2-1.png)
...
**Bước 1** : Cài đặt Slurm Operator, GPU Operator, Network Operator tại phần cài đặt GPU software & chờ cho đến khi trạng thái các phần này ở ready ![](/img/docs/863f4c91673d-Picture3-2.png)
...
![](/img/docs/f1c64bd53fe5-Picture4-1.png)
...
[ Previous Hướng dẫn tích hợp File Storage – High Performance ](./file-storage-high-performance) [ Next VGPU for container  ](./vgpu-for-container)
