...
Serve Gemma open models trên một GPU với vLLM
...
[ Previous Triển khai workload GPU mẫu lên Managed GPU Cluster ](./try-example-workload) [ Next Serve open models trên nhiều GPU với vLLM  ](./multi-gpus-example)
