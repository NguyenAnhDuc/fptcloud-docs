...
Khởi tạo Managed GPU Cluster mới
...
![](/img/docs/a6d7eef243c4-3-1.png)

**Bước 2** : Nhập thông tin tại tab General Information của cụm Cluster sau đó click button **Next** : 

![](/img/docs/15b5adf977f7-4.png)
...
**Bước 3** : Nhập thông tin tại tab Nodes Pool của cụm Cluster sau đó click button **Next** : 
...
Người dùng có thể thêm các worker group khi khởi tạo k8s cluster bằng cách click button **ADD WORKER GROUP**. ![](/img/docs/708902f76129-Screenshot_2.png)
...
![](/img/docs/c7d01a0466a2-Screenshot_1.png)
...
**Bước 4** : Phần **Advanced** là các cài đặt nâng cao

![](/img/docs/126a59aec946-6-1.png)
...
![](/img/docs/0c3879d84282-7-1.png)

Sau khi hệ thống kiểm tra tài nguyên thành công, nhấn button Create a Managed GPU Cluster để tiến hành tạo cụm Cluster.

[ Previous Quản lý Managed GPU Cluster ](./quan-ly-managed-gpu-cluster) [ Next Xem danh sách Managed GPU Cluster đã tạo ](./xem-danh-sach-managed-gpu-cluster)
