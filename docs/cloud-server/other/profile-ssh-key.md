...
![file](/img/docs/83a32b7196d8-image-1698634601692.png)
...
![Userguide FPT Cloud Server 2022 80](/img/docs/3e59c90de69d-Userguide-FPT-Cloud-Server-2022-80-1024x614.png)

Khi người dùng chọn một **Profile SSH Key** cụ thể, hệ thống sẽ hiển thị **Name** , **Public Key.**

![file](/img/docs/3532470cc7cb-image-1734596195350.png)
...
![Userguide FPT Cloud Server 2022 82](/img/docs/a197e82d2ee6-Userguide-FPT-Cloud-Server-2022-82-1024x538.png)

**Bước 2:** Chọn icon **Xóa**. Hệ thống sẽ ngay lập tức xóa **Profile SSH Key** và thông báo kết quả xử lý.

![file](/img/docs/1fdb06f322a7-image-1734596345616.png)
...
[ Previous Xóa Storage Disk ](./xoa-storage-disk) [ Next Token ](./token)
