...
![](/img/docs/288019d594a7-filter-sec-group-1024x510.png)
...
[ Previous Quản lý Security Group ](./quan-ly-security-group) [ Next Manage Priority Rule of Security Group ](./security-group-priority-rule)
