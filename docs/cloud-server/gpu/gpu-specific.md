...
![file](/img/docs/e4b7aeed79b6-image-1705028237983.png)
...
[ Previous Quản lý GPU với Console Portal ](./gpu-general) [ Next Quản lý GPU Server với HPC Portal ](./quan-ly-gpu-voi-hpc-portal)
