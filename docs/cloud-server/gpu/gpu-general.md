...
![file](/img/docs/2ea8b0f3b398-image-1744799866857.png)

**Bước 2** : Chọn GPU và loại card GPU cần sử dụng

![file](/img/docs/215598f9ad30-image-1744799912482.png)

**Bước 3** : Nhập các thông tin còn khác của instance

**Bước 4** : Bấm **Create Instance**

![file](/img/docs/03d823e6ceb9-image-1744799934410.png)

**Bước 5** : Kiểm tra thông tin. Thông tin được cập nhật ở màn hình Instance detail

![file](/img/docs/e3f4b4f16903-image-1744799982286.png)
...
![file](/img/docs/f8405b2ccb8b-image-1744799997207.png)

**Bước 2** : Chọn **Actions** , sau đó chọn **Add GPU**

![file](/img/docs/f556d42e4607-image-1744800019053.png)
...
![file](/img/docs/eba5d6183136-image-1744800059691.png)
...
[ Previous Quản lý GPU với Portal Console ](./gpu) [ Next Quản lý GPU với Console Portal áp dụng cho loại dịch vụ Specific ](./gpu-specific)
