...
![file](/img/docs/d5b7552c4789-image-1712739862804.png)

Một hộp thoại mới sẽ hiện lên và hướng dẫn người dùng các bước tiếp theo.

![Userguide FPT Cloud Server 2022 18](/img/docs/f0c8f0c95d35-Userguide-FPT-Cloud-Server-2022-18-1024x414.png)
...
![file](/img/docs/ab2ee565d54b-image-1724657781979.png)
...
![file](/img/docs/423745c9b070-image-1724661980458.png)

  * Trường hợp tạo máy ảo từ Image: người dùng có thể chọn custom image hoặc ISO image (Xem thêm thông tin lưu ý: Link

![file](/img/docs/e924b03994b4-image-1724661996843.png)

  * Trường hợp tạo máy ảo từ Snapshot/NAT Instance

![file](/img/docs/e60ec9a78193-image-1724662011478.png)

![file](/img/docs/891d0f83ea76-image-1724662017399.png)

**Đối với specific**

![file](/img/docs/f6dd64712588-image-1724662030232.png)
...
![file](/img/docs/1be6927ba475-image-1724662047559.png)
...
![file](/img/docs/c293e47c2528-image-1724662063044.png)
...
![file](/img/docs/14ea2c24c846-image-1724662077573.png)
...
![file](/img/docs/f8be10840d7e-image-1724662090638.png)

  * Nếu sử dụng phương thức Standard, người dùng cần lưu ý ghi nhớ và bảo mật mật khẩu ở nơi an toàn.

![file](/img/docs/d3e63623e89b-image-1724662104611.png)

### **Các thông tin advanced**

![file](/img/docs/16450e30af9a-image-1724662116137.png)
...
![file](/img/docs/c36b4dde08d1-image-1724664453215.png)
...
**![Userguide FPT Cloud Server 2022 21](/img/docs/e04e8c2e6eef-Userguide-FPT-Cloud-Server-2022-21-1024x367.png)**

[ Next Lưu ý khi tạo máy ảo từ file iso ](./create-vm-iso)
