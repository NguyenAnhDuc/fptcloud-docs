...
![Userguide FPT Cloud Server 2022 41](/img/docs/3163067f590a-Userguide-FPT-Cloud-Server-2022-41-1024x498.png)

**Bước 2** : Chọn kích thước mới cho máy ảo, có thể chọn theo template có sẵn hoặc tự chọn cấu hình riêng ở phần **Custom**.

![Userguide FPT Cloud Server 2022 42](/img/docs/6016416adfbb-Userguide-FPT-Cloud-Server-2022-42.png)
...
![Userguide FPT Cloud Server 2022 43](/img/docs/f181b90ff1b2-Userguide-FPT-Cloud-Server-2022-43-1024x524.png)

**Bước 2:** Nhập tên mới cho máy ảo và chọn **Rename.**

![Userguide FPT Cloud Server 2022 44](/img/docs/517e8929c0c7-Userguide-FPT-Cloud-Server-2022-44.png)
...
![Userguide FPT Cloud Server 2022 45](/img/docs/17f8c10f4123-Userguide-FPT-Cloud-Server-2022-45-1024x524.png)

**Bước 2:** Chọn **Reset Password**. Hệ thống sẽ gửi mật khẩu mới về email của người dùng.

[ Previous Tra cứu thông tin, thông số kỹ thuật của máy ảo đã tạo ](./tutorials-tra-cuu-thong-tin-thong-so-ky-thuat-cua-may-ao-da-tao) [ Next Backup máy chủ với Snapshot ](./tutorials-backup-may-chu-voi-snapshot)
