...
![Hình ảnh](/img/docs/54d22928513d-image2e.png)

  * **Advanced**

    * Hiển thị thông tin **Database** và **Search Engine Database**

![Hình ảnh](/img/docs/a43a578f5e8d-image2f.png)

[ Previous Tạo Open Metadata service ](./tao-open-metadata-service) [ Next Cập nhật Open Metadata ](./cap-nhat-open-metadata)
