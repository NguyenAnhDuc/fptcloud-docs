...
Chú ý: Tên connector có thể chứa các kí tự chữ cái thường a-z hoặc các kí tự số 0-9. Đặc biệt không dùng dấu cách có thể thay dấu cách bằng dấu “-”. 
  ...
  * **Database** (required): chọn **S3** ![image-1](/img/docs/1713ae3a4263-sink-S3-1.png)
...
Nhấn **Test Connection** để kiểm tra kết nối từ Workspace tới S3 đã nhập
  ...
  * **Kafka topic**
    ...
    * **Chú ý: giới hạn chỉ lấy tối đa 100 topic ![image-2](/img/docs/567548b25c7f-sink-S3-2.png)
...
**Bước 6** : Nhấn **Next** chuyển qua màn **Additional Properties**
  ...
  * **Mode** : chọn mode ![image-3](/img/docs/abc6eaf6381e-sink-S3-3.png)

**Bước 7** : Nhấn **Next** ở góc phải màn hình để chuyển qua màn **Review** ![image-4](/img/docs/4e100a04663e-sink-S3-4.png)

**Bước 8** : Kiểm tra thông tin, sau đó nhấn **Create** để hoàn thành việc tạo connector

[ Previous 2.15 Clickhouse (Replication) Sink Connector ](./clickhouse-replication-sink-connector) [ Next 2.17 Elasticsearch Sink Connector ](./elasticsearch-sink-connector)
