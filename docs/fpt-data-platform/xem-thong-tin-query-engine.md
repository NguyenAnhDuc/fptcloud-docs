...
![Hình ảnh](/img/docs/665c2dbd97d7-image48-1.png)

**_2\. Authentication_**

Hiển thị thông tin xác thực của **Query engine**

![Hình ảnh](/img/docs/4ccfe19da35a-image49-1.png)
...
![Hình ảnh](/img/docs/a2d8109dc3a2-image4d.png)
...
![Hình ảnh](/img/docs/0e60d94c0643-image50-1.png)

[ Previous Tạo Query engine  ](./tao-query-engine) [ Next Xóa Query Engine  ](./xoa-query-engine)
