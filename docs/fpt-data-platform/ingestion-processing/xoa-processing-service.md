...
![Hình ảnh](/img/docs/13e5c59694c7-image22-1.png)

**Bước 3** : Hiển thị hộp thoại **Delete Application** > nhập **delete** > nhấn **confirm** để xóa hoàn thành việc xóa dịch vụ khỏi workspace 

![Hình ảnh](/img/docs/39d3c99c594d-image28.png)

[ Previous Xem thông tin Processing service ](./xem-thong-tin-processing-service) [ Next Quản lý Compute ](./quan-ly-compute)
