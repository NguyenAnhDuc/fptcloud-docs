...
sidebar_label: "2.6 Oracle source connector"
...
### 2.6. Tạo connector source Oracle
...
![Alt text](/img/docs/651f89610342-31.jpg)

  * **Name** (required): tên connector _

Chú ý:_ Tên connector có thể chứa các ký tự a-z, A-Z, 0-9, dấu gạch ngang "-". Đặc biệt không được dùng ký tự đặc biệt và khoảng trắng.
...
![Alt text](/img/docs/8d12dcac10b2-32.jpg)
...
![Alt text](/img/docs/5f207595ec8b-33.jpg)
...
[ Previous 2.5 MariaDB source connector ](./mariadb-source-connector) [ Next 2.7 Clickhouse (logs) sink connector ](./clickhouse-logs-sink-connector)
