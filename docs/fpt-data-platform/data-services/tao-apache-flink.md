...
![Picture 1](/img/docs/42e8657a19f6-image7-3.png)
...
Nếu người dùng muốn tự động tăng cấu hình **Worker** của **Flink** , tích chọn **Enable worker auto scaling** > nhập số node tối đa cho **Worker**

**Chú ý** : Số max node phải lớn số **Number of nodes** và nhỏ hơn hoặc bằng 10

![Picture 1](/img/docs/dc6db1d3b4cf-image8-3.png)
...
**Chú ý** : số **Slot per task** phải lớn hơn hoặc bằng 1 và nhỏ hơn hoặc bằng 4

  * **Total slot:** số total slot phụ thuộc vào số slot per task

![Picture 1](/img/docs/e78705e76404-image9-3.png)
...
![Picture 1](/img/docs/90bb5415c60c-imagea-3.png)
...
[ Previous Flink ](./apache-flink) [ Next Xem thông tin Apache Flink ](./xem-thong-tin-apache-flink)
