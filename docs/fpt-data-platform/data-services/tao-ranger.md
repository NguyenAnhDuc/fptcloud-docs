...
![Hình ảnh, Hình ảnh](/img/docs/29c69b29e5ab-image43.png)
...
![Hình ảnh, Hình ảnh](/img/docs/4a531c07d0f0-image44.png)
...
![Hình ảnh, Hình ảnh](/img/docs/45fefcbe2437-image45.png)
...
![Hình ảnh, Hình ảnh](/img/docs/2dab269bc7a8-image46.png)
...
**Lưu ý** : Trong **Configure Parameters** của **OpenSearch** , tham số ssl_http cần được cấu hình là False (HTTP) thay vì giá trị mặc định True (HTTPS).
...
![Hình ảnh, Hình ảnh](/img/docs/c1219fcc42f8-image47.png)
...
![Hình ảnh, Hình ảnh](/img/docs/1eebed4ad713-SCR-20250620-iyoz.png)
...
![Hình ảnh, Hình ảnh](/img/docs/b456c4452432-image48.png)
...
[ Previous Ranger ](./guide-ranger) [ Next Xem thông tin Ranger ](./xem-ranger)
