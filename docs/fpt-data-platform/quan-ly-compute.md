...
![Hình ảnh](/img/docs/50a65a6ca97d-image2a.png)
...
![Hình ảnh](/img/docs/afac4049aaca-image29.png)
...
![Hình ảnh](/img/docs/188c5767c967-image2b.png)

**Bước 3** : Hiển thị hộp thoại **Delete Application** > nhập **delete** > nhấn **confirm** để xóa hoàn thành việc xóa dịch vụ khỏi workspace 

![Hình ảnh](/img/docs/eab1fa02c481-SCR-20250526-nxeo.png)

[ Previous Xóa Processing service ](./xoa-processing-service) [ Next Quản lý Image của Compute ](./quan-ly-image-cua-compute)
