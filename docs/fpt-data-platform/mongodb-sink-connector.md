...
**Bước 3:** Tại màn detail **CDC service** > Chọn tab **Connectors** > nhấn **Create a connector** ![image-1](/img/docs/8fc6e021e371-sink-MongoDB-1.png)
...
Chú ý: Tên connector có thể chứa các kí tự chữ cái thường a-z hoặc các kí tự số 0-9. Không. Đặc biệt không dùng dấu cách có thể thay dấu cách bằng dấu “-”. 
  ...
  * Database (required):** chọn MongoDB ![image-2](/img/docs/b318b762ca9b-sink-MongoDB-2.png)
...
Chú ý: tên Database có thể là các chữ cái thường và các chữ cái hoa hoặc các chữ số từ 1-9. Đặc biệt không dùng dấu cách, có thể thay dấu cách bằng dấu ‘-’ và ‘_’ 
    ...
    * **Topics** (required): Danh sách các topics ![image-3](/img/docs/99050869f1f9-sink-MongoDB-3.png)
...
**Bước 8:** Điền các thông tin:
  ...
  * **Tasks max(required):** Số lượng task mà connector có thể chạy đồng thời, nếu topics có số lượng partition lớn hơn 1 ![image-4](/img/docs/8fca6e798bf1-sink-MongoDB-4.png)

**Bước 9** : Nhấn **Next** để chuyển qua màn **Review** ![image-5](/img/docs/5081f6d06fd3-sink-MongoDB-5.png)

**Bước 10:** Kiểm tra thông tin và nhấn nút **Create** để hoàn thành việc tạo connector. ![image-6](/img/docs/3af6e2b0ef37-sink-MongoDB-6.png)

[ Previous 2.7 Clickhouse (logs) sink connector ](./clickhouse-logs-sink-connector) [ Next 2.9 PostgreSQL Sink Connector ](./postgresql-sink-connector)
