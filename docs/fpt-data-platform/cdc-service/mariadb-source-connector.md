...
**Bước 3:** Tại màn detail **CDC service** > Chọn tab **Connectors** > nhấn **Create** a connector ![image-1](/img/docs/969503907479-source-MariaDB-1.png)
...
Chú ý: Tên connector có thể chứa các kí tự chữ cái thường a-z hoặc các kí tự số 0-9. Đặc biệt không dùng dấu cách có thể thay dấu cách bằng dấu “-”.
  ...
  * **Database (required):** chọn **SQLserver** ![image-2](/img/docs/9441dc119373-source-MariaDB-2.png)
...
Nhập thông tin màn **Properties**
  ...
  * Trường hợp chọn **Manual configuration** \- Điền các thông tin:
    ...
    * **Topics (required):** Danh sách các topics Connector sẽ consume và sink dữ liệu vào database đích, và được ngăn cách bởi dấu "," ![image-3](/img/docs/1ef5ddb4d007-source-MariaDB-3.png)
...
Chú ý: Database server ID phải là số và phải lớn hơn 1000 và nhỏ hơn 9999.
    ...
    * **Topics (required):** Danh sách các topics Connector sẽ consume và sink dữ liệu vào database đích, và được ngăn cách bởi dấu "," ![image-4](/img/docs/c6958f765be3-source-MariaDB-4.png)
...
**Bước 7:** Nhấn **Next** để chuyển sang màn **Review** ![image-6](/img/docs/aebb20071e28-source-MariaDB-6.png)

**Bước 8:** Kiểm tra thông tin sau đó nhấn **Create** để hoàn thành việc tạo connector

[ Previous 2.4 MySQL source connector ](./mysql-source-connector) [ Next 2.6 Oracle source connector ](./oracle-source-connector)
