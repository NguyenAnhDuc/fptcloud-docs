...
**1.** Để thực hiện **CDC với SQL server** , trước hết phải _enable_ **SQLServer Agent**.
  ...
  * Với dịch vụ của FPTCloud, vui lòng liên hệ Support để được hỗ trợ.
...
**Bước 3:** Tại màn detail **CDC service** > Chọn tab **Connectors** > nhấn **Create a connector** ![image-1](/img/docs/5bc7b08a737a-source-SQLserver-1.png)
...
_Chú ý: Tên connector có thể chứa các kí tự chữ cái thường a-z hoặc các kí tự số 0-9. Đặc biệt không dùng dấu cách có thể thay dấu cách bằng dấu “-”._
  ...
  * **Database (required): chọn SQLserver ![image-2](/img/docs/7d0f53f55e43-source-SQLserver-2.png)
...
Nhập thông tin màn **Properties**
  ...
  * Trường hợp chọn **Manual configuration** \- điền các thông tin:
    ...
    * **Topics (required):** Danh sách các topics Connector sẽ consume và sink dữ liệu vào database đích, và được ngăn cách bởi dấu "," ![image-3](/img/docs/5875eb3fa1f9-source-SQLserver-3.png)
  ...
  * Trường hợp chọn **From Database Engine** \- điền các thông tin:
    ...
    * **Topics (required):** Danh sách các topics Connector sẽ consume và sink dữ liệu vào database đích, và được ngăn cách bởi dấu "," ![image-4](/img/docs/4fd7630e4143-source-SQLserver-4.png)
...
**Bước 6:** Nhấn **Next** để chuyển qua màn **Additional Properties**
  ...
  * Nhập các thông tin sau:
    ...
    * **Column (optional):** tên một cột dữ liệu muốn lấy ra trong table ![image-5](/img/docs/9d6a791b2119-source-SQLserver-5.png)

**Bước 7:** Nhấn **Next** để chuyển sang màn **Review** ![image-6](/img/docs/249f627f5150-source-SQLserver-6.png)

**Bước 8:** Kiểm tra thông tin sau đó nhấn **Create** để hoàn thành việc tạo connector

[ Previous 2.2 MongoDB source connector ](./mongodb-source-connector) [ Next 2.4 MySQL source connector ](./mysql-source-connector)
