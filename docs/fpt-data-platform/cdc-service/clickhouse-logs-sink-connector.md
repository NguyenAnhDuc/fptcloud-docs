...
**Bước 3:** Tại màn detail **CDC service** > Chọn tab **Connectors** > nhấn **Create a connector** ![image-1](/img/docs/d04dea39c051-clickhouse-logs-1.png)
...
Chú ý: Tên connector có thể chứa các kí tự chữ cái thường a-z hoặc các kí tự số 0-9. Đặc biệt không dùng dấu cách có thể thay dấu cách bằng dấu “-”. 
  ...
  * **Database** (required): chọn ClickHouse(log) ![image-2](/img/docs/144ebf90c152-clickhouse-logs-2.png)
...
Nhập thông tin sau:
  ...
  * Trường hợp chọn **Manual configuration** \- Điền các thông tin:
    ...
    * **Topics** (required): Danh sách các topics Connector sẽ consume và sink dữ liệu vào ClickHouse, và được ngăn cách bởi dấu "," ![image-3](/img/docs/75a87aaacc4b-clickhouse-logs-3.png)
...
Điền các thông tin:
  ...
  * **Mode** (required): Hành vi của Connector khi không thể xử lý được message 
    ...
    * **All** : Các message lỗi sẽ được gửi vào topic được nhập ![image-4](/img/docs/b0b61d80796e-clickhouse-logs-4.png)

**Bước 7** : Nhấn **Next** để chuyển qua màn **Review** ![image-5](/img/docs/c238619e5159-clickhouse-logs-5.png)

**Bước 8:** Kiểm tra thông tin và nhấn nút **Create** để hoàn thành việc tạo connector. ![image-6](/img/docs/ba5dfd4cc567-clickhouse-logs-6.png)

[ Previous 2.6 Oracle source connector ](./oracle-source-connector) [ Next 2.8 MongoDB Sink Connector ](./mongodb-sink-connector)
