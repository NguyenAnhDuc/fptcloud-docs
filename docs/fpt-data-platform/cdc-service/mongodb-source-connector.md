...
**Bước 3:** Tại màn detail **CDC service** > Chọn tab **Connectors** > nhấn **Create a connector** ![connector-details](/img/docs/91b625fc4532-1.png)
...
**Bước 4:** Nhập các thông tin màn **Connector Information:**
  ...
  * **Name (required):** tên Connector *Chú ý: Tên connector có thể chứa các kí tự chữ cái thường a-z hoặc các kí tự số 0-9. Đặc biệt không dùng dấu cách có thể thay dấu cách bằng dấu “-”.
    ...
    * **Database (required):** chọn MongoDB ![create-step1](/img/docs/0dc12ee9e4bc-2.png)
...
![image-3](/img/docs/a6d0496d3c31-3.png)
  ...
  * Trường hợp chọn **Manual configuration** \- điền các thông tin sau
    ...
    * **Topic prefix (required):** Prefix of topic name (.database.collection). ![image-4](/img/docs/0ef3f82b2ae8-4.png)
...
[ Previous 2.1 PostgreSQL source connector ](./postgresql-source-connector) [ Next 2.3 SQL Server source connector ](./sql-server-source-connector)
