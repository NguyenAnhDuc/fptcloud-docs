...
**Lưu ý:**
  ...
  * Thao tác truy cập qua luồng cũ tương tự như [Hướng dẫn truy cập qua Web Browser](https://fptcloud.com/documents/fpt-cloud-desktop/?doc=truy-cap-qua-web-browser), chỉ khác là tại bước truy cập chọn máy ảo, người dùng chọn phương thức truy cập qua FCDClient
...
![file](/img/docs/1796a9b2c2c9-image-1767956660879.png)

=> Đăng nhập Authenticator (Server) thành công

* * *

Nếu người dùng truy cập từ URL mặc định của dịch vụ:
...
[ Previous Truy cập qua Web browser ](./accountpassword-qua-web-browser)
