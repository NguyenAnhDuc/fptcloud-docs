...
**Tham khảo thêm** : [FPT Cloud Managed Kubernetes Autoscaler](<https://fptcloud.com/documents/managed-fpt-kubernetes-engine/?doc=cluster-autoscale>)

![](/img/docs/1be5f3e3cf9d-Picture22-1.png)

[ Previous Hướng dẫn sử dụng GPU Telemetry ](./huong-dan-su-dung-gpu-telemetry) [ Next Hướng dẫn sử dụng các chế độ GPU sharing  ](./huong-dan-su-dung-cac-che-do-gpu-sharing)
