...
![Userguide FPT WAF 2022 42](/img/docs/3ae15c86d4e2-Userguide-FPT-WAF-2022-42-1024x578.png)
...
![Userguide FPT WAF 2022 43](/img/docs/ee9a083855fd-Userguide-FPT-WAF-2022-43-1024x578.png)

**Bước 3:** Chọn **Create Security Rule Set** để lưu và hoàn tất việc tạo **Rule Set**.

![Userguide FPT WAF 2022 44](/img/docs/9ec97a49c5c1-Userguide-FPT-WAF-2022-44-1024x578.png)
...
![Userguide FPT WAF 2022 45](/img/docs/d229308029ff-Userguide-FPT-WAF-2022-45-1024x578.png)
...
![Userguide FPT WAF 2022 46](/img/docs/741730363644-Userguide-FPT-WAF-2022-46-1024x578.png)

**Bước 3:** Chọn **Creat Rule** để thực hiện tạo Rule mới.

![Userguide FPT WAF 2022 47](/img/docs/af74e7d24b7a-Userguide-FPT-WAF-2022-47-1024x578.png)

[ Previous Quản lý SSL Certificates ](./quan-ly-ssl-certificates) [ Next Quản lý người dùng của WAF Dashboard ](./quan-ly-nguoi-dung-cua-waf-dashboard)
