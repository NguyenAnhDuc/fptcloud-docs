...
Ở **WAF Dashboard** , chọn **Overview**. Ở màn hình này sẽ hiển thị các thông số được thống kê và update liên tục.
...
[ Previous Đăng nhập WAF Dashboard ](./tutorials-dang-nhap-waf-dashboard) [ Next Quản lý Proxy Host ](./quan-ly-proxy-host)
