...
![Userguide FPT WAF 2022 6](/img/docs/144ab6abe20d-Userguide-FPT-WAF-2022-6-1024x538.png)
...
![Userguide FPT WAF 2022 7](/img/docs/743bb54de3d0-Userguide-FPT-WAF-2022-7-1024x538.png)

**Bước 2:** Nhập các thông tin theo hướng dẫn ở phần **Quản lý SSL Certificates**

![Userguide FPT WAF 2022 8](/img/docs/dac448e9b760-Userguide-FPT-WAF-2022-8-1024x538.png)
...
![Userguide FPT WAF 2022 9](/img/docs/d28bf8272b35-Userguide-FPT-WAF-2022-9-1024x538.png)

[ Previous Đăng nhập WAF Dashboard ](./dang-nhap-waf-dashboard)
