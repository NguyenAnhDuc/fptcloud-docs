...
## Hướng dẫn nhanh (Quick Starts) 
  ...
  * [ Sửa static IP trên Ubuntu server ](./change-static-ip-in-ubuntu-server)
  * [ Sửa static IP trên Window server ](./change-static-ip-in-window-server)
  * [ Sửa static IP trên CentOS ](./change-statis-ip-in-centos)
