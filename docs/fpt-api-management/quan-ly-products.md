...
sidebar_label: "1. Khai báo Product"
...
![Userguide FPT API Management 42](/img/docs/10a13d66f6e4-Userguide-FPT-API-Management-42-1024x538.png)

**Bước 2** : Nhập các thông tin mới và chọn **OK**.

![Userguide FPT API Management 43](/img/docs/26ece1a387c7-Userguide-FPT-API-Management-43-1024x538.png)
...
![Userguide FPT API Management 44](/img/docs/ce6ff2825944-Userguide-FPT-API-Management-44-1024x538.png)

**Bước 3** : Chọn **Yes** để xác nhận.

![Userguide FPT API Management 45](/img/docs/426f4f56475a-Userguide-FPT-API-Management-45.png)
...
![Userguide FPT API Management 46](/img/docs/da46540b372a-Userguide-FPT-API-Management-46-1024x538.png)
...
[ Previous Quản lý REST APIs ](./quan-ly-rest-apis) [ Next Quản lý API site ](./quan-ly-api-site)
