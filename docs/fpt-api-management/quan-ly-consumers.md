...
![Userguide FPT API Management 54](/img/docs/ae92854bce40-Userguide-FPT-API-Management-54-1024x538.png)

**Bước 3:** Chọn **OK** để lưu.

![Userguide FPT API Management 55](/img/docs/160261070117-Userguide-FPT-API-Management-55.png)
...
![Userguide FPT API Management 56](/img/docs/cfc6b966c672-Userguide-FPT-API-Management-56-1024x538.png)

**Bước 2:** Nhập các thông tin mới và chọn **OK**.

![Userguide FPT API Management 57](/img/docs/7fe0874b39cf-Userguide-FPT-API-Management-57-1024x538.png)
...
![Userguide FPT API Management 58](/img/docs/c31b656b58dc-Userguide-FPT-API-Management-58-1024x590.png)

**Bước 2:** Lấy thông tin Username ở trường **Basic Authen User.**

![Userguide FPT API Management 59](/img/docs/134f47e52e7a-Userguide-FPT-API-Management-59-1024x590.png)
...
![Userguide FPT API Management 60](/img/docs/14edb59b64d4-Userguide-FPT-API-Management-60-1024x590.png)

**Bước 2:** Lấy thông tin API Key ở trường **Api key.**

![Userguide FPT API Management 61](/img/docs/bca437e1de8c-Userguide-FPT-API-Management-61-1024x590.png)
...
![Userguide FPT API Management 62](/img/docs/8c38acd6f55c-Userguide-FPT-API-Management-62-1024x538.png)
...
[ Previous Quản lý API site ](./quan-ly-api-site) [ Next Analytics ](./analytics)
