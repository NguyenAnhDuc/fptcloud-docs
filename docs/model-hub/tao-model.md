...
![](/img/docs/661ce3b5ee53-Picture9.png) ![](/img/docs/6db13648c364-Picture10.png) Bước 2: Tại step 1 Basic Infomation, nhập Model title 
...
Bước 7: Click button Next để chuyển sang step 2 sau khi đã điền đầy đủ thông tin ở step 1 ![](/img/docs/befcf99e36c9-Picture11.png) Bước 8: Tại step 2 Tags, thực hiện chọn lần lượt các tag cho Framework, Architecture, Subject, Task, Others 
...
[ Previous Chi tiết model ](./chi-tiet-model) [ Next Sửa model ](./sua-model)
