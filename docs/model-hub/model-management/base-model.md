...
![](/img/docs/205447ff6a0a-anh-8.png) Lưu ý: chỉ được phép chọn 1 base model. Trường này không bắt buộc, người dùng có thể để trống
...
![](/img/docs/4ab19bb5fd7a-anh-9.png)
...
![](/img/docs/5c5813041a99-anh-10.png)
...
![](/img/docs/3de031d8d6f1-anh-11.png)

[ Previous Clone model (v1.1) ](./clone-model) [ Next Create organization (v1.1) ](./create-organization)
