...
Bước 1: Tại màn danh sách model, click vào dropdown list, có 4 option cho bạn lựa chọn tùy theo nhu cầu sắp xếp danh sách model, lần lượt là: Last modified, last created, alphabetic (A-Z), alphabetic (Z-A). Bước 2: Sau khi chọn 1 option, màn hình trả ra danh sách model được sắp xếp theo lựa chọn tương ứng ![](/img/docs/b6be0846a55b-Picture2.png) Ngoài ra, hệ thống còn cho phép filter ra danh sách các model tùy theo nhu cầu tìm kiếm bằng cách kết hợp 1 hay nhiều filter với nhau. Để filter các model, bạn làm như sau: Bước 1: Click vào biểu tượng filter, màn hình hiển thị ra popup với các option để filter ![](/img/docs/111969985e02-Picture3.png) ![](/img/docs/f31e5037cf4f-Picture4.png) Bước 2: Apply các filter tương ứng, click button Apply, màn hình trả ra kết quả các model tương ứng với filter. Để hiển thị lại toàn bộ danh sách model, click button Clear

[ Previous Đăng nhập vào trang Portal ](./dang-nhap) [ Next Chi tiết model ](./chi-tiet-model)
