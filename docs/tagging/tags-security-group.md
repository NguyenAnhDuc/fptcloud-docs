...
sidebar_label: "Manage tag to Security group"
title: "2. Tagging"
...
![file](/img/docs/efbc40e02352-image-1721034894848.png)
...
![file](/img/docs/a8960341c7d3-image-1721034908522.png)

**Bước 2** : Hộp thoại hiện ra, người dùng chọn tag để gắn vào security group.

![file](/img/docs/ded21a16bc7a-image-1721034922176.png)
...
![file](/img/docs/b25bc9ee5501-image-1721034933906.png)

[ Previous Manage tag to Subnet ](./tags-subnet) [ Next Manage tag to classic load balancer ](./tagg-lb)
