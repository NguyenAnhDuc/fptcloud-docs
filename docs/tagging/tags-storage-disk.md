...
![file](/img/docs/ea32f78fc8b5-image-1721014373921.png)

**Bước 2** : Hộp thoại hiện ra, người dùng chọn tag để gắn vào storage disk.

![file](/img/docs/5a901255112c-image-1721014531446.png)
...
![file](/img/docs/40fabdec1ffa-image-1721014918750.png)

[ Previous Manage tag to Instance Management ](./tags-instance) [ Next Manage tag to Snapshot ](./tags-snapshot)
