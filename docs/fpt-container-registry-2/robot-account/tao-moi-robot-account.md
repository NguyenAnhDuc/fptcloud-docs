...
![](/img/docs/8e6c388e53fa-Picture59.png)

**Bước 2** : Chọn **NEW ROBOT ACCOUNT**. Nhập thông tin để khởi tạo một **Robot Account**

![](/img/docs/4718d2bbf4c3-Picture60.png) ![](/img/docs/b449c47e3f1f-Picture61.png)
...
![](/img/docs/f6c856f2e562-Picture62.png)

**Lưu ý** : _Để đảm bảo an toàn bảo mật thông tin Username/Token chỉ hiển thị một lần duy nhất. Người dùng cần lưu ở nơi an toàn._

Kết quả sau khi tạo thành công robot account: 

![](/img/docs/a14d0bfe34fc-Picture63.png)

[ Previous Quản lý Robot Account  ](./quan-ly-robot-account) [ Next Xem danh sách Robot Account  ](./xem-danh-sach-robot-account)
