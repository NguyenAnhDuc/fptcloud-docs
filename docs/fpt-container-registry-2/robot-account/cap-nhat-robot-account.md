...
![](/img/docs/ebd6b02ffd76-Picture68.png)

[ Previous Xem danh sách Robot Account  ](./xem-danh-sach-robot-account) [ Next Disable Robot Account đang sử dụng  ](./disable-robot-account-dang-su-dung)
