...
### Những điều cần lưu ý trước khi bạn cấu hình card NIC:
  ...
  * Đây là tính năng nâng cao, chỉ dành cho người có kiến thức nhất định về xây dựng và quản lý hệ thống mạng máy tính.

  * Thiết lập mạng kết nối: Xác định mạng kết nối cho card NIC, đảm bảo máy ảo có thể giao tiếp và truy cập tài nguyên mạng một cách hiệu quả.

  * Xác định cấu hình IP: Cấu hình địa chỉ IP, subnet mask, gateway và DNS cho card NIC sao cho máy ảo có thể kết nối vào mạng.
...
## Hướng dẫn nhanh (Quick Starts) 
  ...
  * [ Khởi tạo card Network Interface Card - Primary ](./create-card-nic--primary)
  * [ Disable Network Interface Card ](./disable-nic-card)
  * [ Enable Network Interface Card ](./enable-nic-card)

## Hướng dẫn chi tiết (Tutorials) 

  * [ Thêm Network Interface Card mới ](./add-card-nic--new)
  * [ Chuyển card thường thành card Primary ](./convert-card)
  * [ Edit IP Address ](./edit-ip-address)
  * [ Thay đổi địa chỉ MAC ](./change-address-mac)
  * [ Xóa Network Interface Card ](./delete-card-nic)
