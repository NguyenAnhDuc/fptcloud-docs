...
**Pool** :
       ...
       -[Pool] Request/s: Lượng request được gửi đến nhóm máy chủ backend trên mỗi giây. Cho biết tổng khối lượng công việc mà bộ cân bằng tải đang phân phối.
...
[ Previous Update Load Balancer ](./cap-nhat-load-balancer) [ Next Thêm External member cho Load Balancer ](./them-external-member)
