...
**External member** đã được thêm khi khởi tạo **Load Balancer,** người dùng tham khảo cách tạo Load Balancer [tại đây.](https://fptcloud.com/documents/load-balancer/?doc=chinh-sua-listener)
...
[ Previous Theo dõi biểu đồ giám sát Load Balancer ](./theo-doi-bieu-do-load-balancer) [ Next Resize cho Load Balancer ](./resize-load-balancer)
