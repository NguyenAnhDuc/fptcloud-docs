...
Người dùng có thể xem log tại file tải xuống dưới dạng .log với: 
    ...
    -Tên định dạng của file: loadbalancer_accesslogs__starttime_endtime  

(Trong đó: **start time & end time theo format: YYYYMMDDTHH:mmTimezone Thời gian theo browser time**, VD:20240729T2300+0700)

[ Previous Resize cho Load Balancer ](./resize-load-balancer) [ Next Tích hợp Metric/Access logs Load Balancer với FPT Monitoring (FMON) ](./tich-hop-fmon)
