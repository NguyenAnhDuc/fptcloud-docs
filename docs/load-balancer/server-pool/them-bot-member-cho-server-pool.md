...
**Bước 1:** Tại màn hình hiển thị danh sách **Server pool** , chọn **Server pool** cần thêm member. ![file](/img/docs/82cb406f5643-image-1710989399033.png)
...
![file](/img/docs/ca679a805af0-image-1710989438271.png)
...
Để xoá **Server pool member,** trong phần **Action** của **Server pool member** cần xoá, chọn **Remove**. ![file](/img/docs/16ee6e91e109-image-1710989470976.png)

[ Previous Khởi tạo Server Pool ](./khoi-tao-server-pool) [ Next Chỉnh sửa cấu hình Health check ](./chinh-sua-cau-hinh-health-check)
