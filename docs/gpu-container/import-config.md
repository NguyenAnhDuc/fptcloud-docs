...
![Alt text](https://fptcloud.com/wp-content/uploads/2025/09/import-1.png)
...
![Alt text](https://fptcloud.com/wp-content/uploads/2025/09/import-3.png)
...
Click **Review** to continue. On this screen, you can: 
  ...
  * Check pricing summary to view the estimated hourly cost. ![Alt text](https://fptcloud.com/wp-content/uploads/2025/09/import-4.png)
...
[ Previous Using GUI ](./create-via-gui) [ Next Export Container Configuration ](./export-config)
