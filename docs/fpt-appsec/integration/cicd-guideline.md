...
![CICD flow](/img/docs/0f7aa110ee8c-Screenshot-2026-01-22-113824.png)
...
Tên | Loại | Bắt buộc | Mô tả  
---|---|---|---  
team_code | string | Có | Mã của nhóm FSEC, cách lấy team_code [tại đây](<https://fptcloud.com/documents/fpt-security-platform/?doc=cai-dat-team>)  
git_repo_url | string | Có | URL kho lưu trữ Git (ví dụ: GitHub hoặc GitLab)  
access_key | string | Có | Khóa truy cập do FSEC cấp để truy cập kho lưu trữ, lấy access_key tại màn hình Integration detail[tại đây](<https://fptcloud.com/documents/fpt-security-platform/?doc=guide-gitlabserver>), tương tự với các loại tích hợp khác  
...
team_code | string | Có | Mã của nhóm FSEC, cách lấy team_code [tại đây](<https://fptcloud.com/documents/fpt-security-platform/?doc=cai-dat-team>)  
git_repo_url | string | Có | URL kho lưu trữ Git (ví dụ: GitHub hoặc GitLab)  
access_key | string | Có | Khóa truy cập do FSEC cấp để truy cập kho lưu trữ, cách lấy access_key của GitLab server [tại đây](<https://fptcloud.com/documents/fpt-security-platform/?doc=guide-gitlabserver>), tương tự với các loại tích hợp khác  
branch | string | Có | Tên nhánh cần quét  
...
**Ví dụ**
    ...
    POST /api/v1/xplat/fsp-service/core-service/integration/scan-code?scan-mode=commit HTTP/1.1
    Host: api.yourdomain.com
    Orgid: 123e4567-e89b-12d3-a456-426614174000
    Accept: application/json
    Content-Type: application/json
...
**Ví dụ**
    ...
    POST /api/v1/xplat/fsp-service/core-service/integration/scan-secret HTTP/1.1
    Host: api.yourdomain.com
    Orgid: 123e4567-e89b-12d3-a456-426614174000
    Accept: application/json
    Content-Type: application/json
...
**Ví dụ**
    ...
    POST /api/v1/xplat/fsp-service/core-service/integration/scan-secret?scan-mode=commit HTTP/1.1
    Host: api.yourdomain.com
    Orgid: 123e4567-e89b-12d3-a456-426614174000
    Accept: application/json
    Content-Type: application/json
...
---|---|---|---  
team_code | string | Có | Mã của nhóm FSEC, cách lấy team_code [tại đây](<https://fptcloud.com/documents/fpt-security-platform/?doc=cai-dat-team>)  
access_key | string | Có | Khóa truy cập do FSEC cấp cho registry image, cách lấy access_key của GitLab server [tại đây](<https://fptcloud.com/documents/fpt-security-platform/?doc=guide-gitlabserver>), tương tự với các loại tích hợp khác  
image_url | string | Có | Đường dẫn registry và tag của image (ví dụ: repo:tag)  
  
**Ví dụ**
    
    
    POST /api/v1/xplat/fsp-service/core-service/integration/scan-image HTTP/1.1
    Host: api.yourdomain.com
    Orgid: 123e4567-e89b-12d3-a456-426614174000
    Accept: application/json
    Content-Type: application/json
...
access_key | string | Có | Khóa truy cập do FSEC cấp, cách lấy access_key của GitLab server [tại đây](<https://fptcloud.com/documents/fpt-security-platform/?doc=guide-gitlabserver>), tương tự với các loại tích hợp khác  
  
**Ví dụ**
    
    
    POST /api/v1/xplat/fsp-service/core-service/integration/get-scan-code-result HTTP/1.1
    Host: api.yourdomain.com
    Orgid: 123e4567-e89b-12d3-a456-426614174000
    Accept: application/json
    Content-Type: application/json
...
**Ví dụ**
    ...
    POST /api/v1/xplat/fsp-service/core-service/integration/get-scan-secret-result HTTP/1.1
    Host: api.yourdomain.com
    Orgid: 123e4567-e89b-12d3-a456-426614174000
    Accept: application/json
    Content-Type: application/json
...
**Ví dụ**
    ...
    POST /api/v1/xplat/fsp-service/core-service/integration/get-scan-image-result HTTP/1.1
    Host: api.yourdomain.com
    Orgid: 123e4567-e89b-12d3-a456-426614174000
    Accept: application/json
    Content-Type: application/json
...
[ Previous Harbor ](./guide-harbor) [ Next Workspace Management - Quản lý Asset và Issue ](./guide-workspace)
