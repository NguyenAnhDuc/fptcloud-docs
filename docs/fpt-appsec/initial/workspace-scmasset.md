...
_Lưu ý: Pop-up add asset chỉ hiện lên khi loại asset source (GitHub/GitLab/GitLab) được tích hợp tại màn**Integration**. Trường hợp ấn vào 1 souce chưa được tích hợp, màn hình sẽ chuyển sang tab **Integration** của loại source đó _.
...
![Alt text](/img/docs/29caace27a05-a1.jpg)
...
![Alt text](/img/docs/74cfdb07f76c-a2.jpg)
...
![Alt text](/img/docs/04b8efd837e4-a3.jpg)

_Lưu ý:_ _Danh sách mặc định được sắp xếp theo Score giảm dần và mỗi trang hiển thị tối đa 10 issue._

### 3.2. Xem thông tin Issue

  * Tại màn hình Issue List, mỗi issue được hiển thị dưới dạng Issue Info Card với các thông tin:

![Alt text](/img/docs/68d75c1d786b-a4.jpg)
  ...
  * Note Status: nút thay đổi trạng thái (disable nếu không được phép, link hướng dẫn [tại đây](<https://fptcloud.com/documents/fpt-appsec/?doc=guide-change-status-issue-list>))
...
![Alt text](/img/docs/3147a913517b-a5.jpg)
...
![Alt text](/img/docs/f4cba640af12-a6.jpg)
...
![Alt text](/img/docs/67856fbcbc09-a6.1.jpg)
...
![Alt text](/img/docs/2e85bb934945-a9.jpg)
...
![Alt text](/img/docs/b7dd8b2b7931-a10.1.jpg)

**Bước 2** : Chọn action "Rescan", hệ thống sẽ thực hiện scan lại asset hoặc scan type tương ứng và hiện thông báo _"Rescan requested successfully"_

![Alt text](/img/docs/9384c219613b-a10.jpg)
...
![Alt text](/img/docs/cbb7ee44dbc7-a11.png)
...
![Alt text](/img/docs/beb19e360dbf-a12.jpg)
...
![Alt text](/img/docs/f93bcda012cf-a13.jpg)

**Bước 3** : Nhập chính xác từ khóa **disable** vào ô xác nhận rồi nhấn Confirm. Nếu nhập sai, hệ thống hiển thị thông báo lỗi: _"Type correct phrase to confirm your action."_

![Alt text](/img/docs/8be1bbf46537-a14.jpg)
...
![Alt text](/img/docs/62e36a0dea04-a17.jpg)
...
![Alt text](/img/docs/4175bb2b9248-a18.jpg)
...
[ Previous Workspace Management - Quản lý Asset và Issue ](./guide-workspace) [ Next Hướng dẫn thực hiện các thao tác cơ bản với Container Registry asset (image) ](./workspace-crasset)
