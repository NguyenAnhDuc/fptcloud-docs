...
## Hướng dẫn nhanh (Quick Starts) 
  ...
  * [ Quản lý instance schedules ](./manage-version-schedules)
    * [ Tạo một instance schedule mới ](./create-new-instance)
    * [ Xem chi tiết một instance schedule ](./view-detail-instance)
    * [ Xóa một instance schedule ](./delete-instance-schedule)
  * [ Sử dụng instance schedules cho các máy ảo ](./use-instance-schedules-for-virtual-machines)
    * [ Gắn một hoặc nhiều máy ảo vào instance schedule ](./attach-schedule-to-instance)
    * [ Gỡ một hoặc nhiều máy ảo ra khỏi instance schedule ](./detach-schedule-to-instance)
