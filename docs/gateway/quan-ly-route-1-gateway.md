...
sidebar_label: "Quản lý Route của 1 Gateway"
title: "2. Gateway"
...
[ Previous Quản lý danh sách Gateway ](./quan-ly-danh-sach-gateway) [ Next Hệ thống cho phép người dùng quản lý NAT rule trong từng Gateway ](./quan-ly-nat-tung-gateway)
