...
![file](/img/docs/fe150ddd5b0c-image-1754290989063.png)
...
[ Previous Quản lý Route của 1 Gateway ](./quan-ly-route-1-gateway) [ Next Hệ thống cho phép người dùng quản lý NO NAT rule trong từng Gateway ](./quan-ly-no-nat-rule-theo-gateway)
