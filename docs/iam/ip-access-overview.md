...
* * *
  ...
  * **Lưu ý:** tính năng IP Access không áp dụng đối với Tenant Owner, tất cả Tenant Owner không bị giới hạn truy cập.

[ Previous IP Access ](./ip-access) [ Next Khởi tạo một record IP access mới ](./create-ip-)
