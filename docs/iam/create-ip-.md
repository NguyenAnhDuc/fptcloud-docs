...
![file](/img/docs/fe4d7e222e60-image-1711511716480.png)

**Bước 2** : Chọn **Create**.

![](/img/docs/374cb3a86f5d-Screenshot_20-1024x366.png)
...
![](/img/docs/20d826932684-Screenshot_17-1024x549.png)

Sau khi khởi tạo thành công, record sẽ xuất hiện ở màn hình danh sách

![](/img/docs/978a41cd6c63-Screenshot_19-1024x362.png)

[ Previous IP Access Overview ](./ip-access-overview) [ Next Xóa record IP access ](./delete-ip-access)
