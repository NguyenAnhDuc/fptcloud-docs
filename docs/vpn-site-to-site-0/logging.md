...
![](/img/docs/088dfdf70de3-Screenshot-2025-09-12-103802-1.png) **Bước 2:** Quý khách theo dõi lịch sử hoạt động của dịch vụ. 

![](/img/docs/b231479b8330-Screenshot-2025-09-12-103908.png)
...
[ Previous Hướng dẫn cài đặt cảnh báo thông qua dịch vụ Cloud Guard ](./set_alert) [ Next Theo dõi dịch vụ thông qua tính năng monitoring ](./monitoring)
