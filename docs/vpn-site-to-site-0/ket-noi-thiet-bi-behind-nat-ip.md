...
![file](/img/docs/dcad44853bcb-image-1761623133375.png)

Chọn khởi tạo VPN Gateway Sau khi đã có VPN Gateway, chọn **Next** để tạo VPN connection 

![file](/img/docs/e8802c4d7920-image-1761623371500.png)

**Bước 2** : Quý khách thực hiện nhập thông tin cấu hình: 

![file](/img/docs/b14ecf97737e-image-1761623466253.png)
...
**Phần 1: General information** ![file](/img/docs/b14ecf97737e-image-1761623466253.png)
...
**Phần 2: Remote VPN Information** ![file](/img/docs/9a4ca0c9ce35-image-1761623732743.png)
...
Nếu bạn chưa có Customer Gateway, vui lòng click [tại đây](<https://fptcloud.com/documents/vpn-site-to-site-0/?doc=create-customergw>) để xem hướng dẫn khởi tạo  
...
**Phần 3: Dead Peer Detection** ![file](/img/docs/f3b0b9efa799-image-1761623789897.png)
...
**Phần 4: Advanced Information** ![file](/img/docs/95fcf249842f-image-1761625699218.png)
...
[ Previous Hướng dẫn download file config VPN ](./tai-file-cau-hinh-vpn) [ Next Hướng dẫn tạo Customer gateway ](./create-customergw)
