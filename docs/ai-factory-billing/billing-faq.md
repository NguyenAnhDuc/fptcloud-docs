...
### Do I have to pay tax for the usage of the FPT AI Factory?
...
### Which services of FPT AI Factory are eligible for billing?
...
### Where can I check the credit transaction?

Navigate to the **Credit History** tab on the **Billing page** (left menu sidebar). 

* * *

### Can my credits be used in both the Vietnam and Japan regions?
