...
Your **Total Balance** is the current available credits you can use for our service. ![Alt text](https://fptcloud.com/wp-content/uploads/2025/07/image2025-6-28_21-29-54.png) It consists of two components:

  * **Top-up Balance** : Credits purchased via payment methods such as **VNPAY** , **Stripe.**
  * **Voucher Balance** : Credits redeemed from a **voucher code** , typically provided by **FPT** for **trials, proofs of concept (POCs), promotions** , or other special programs.
...
[ Next Low Balance Threshold Alert ](./low-balance-threshold-alert)
