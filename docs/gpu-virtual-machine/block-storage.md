...
To create a Storage disk in FPT Cloud, first identify the type of disk you need: 
  ...
  * **Root disk** is automatically created along with the virtual machine. References: [Create a GPU VM](<https://fptcloud.com/en/documents/gpu-virtual-machine-en/?doc=block-storage>)
...
![Alt text](https://fptcloud.com/wp-content/uploads/2025/03/Block-Storage-1.png)
...
![Alt text](https://fptcloud.com/wp-content/uploads/2025/03/Block-Storage-2.png)
...
![Alt text](https://fptcloud.com/wp-content/uploads/2025/03/Block-Storage-4.png)
...
![Alt text](https://fptcloud.com/wp-content/uploads/2025/03/Block-Storage-5.png)

**2.** Choose the target virtual machine from the popup window and click **Attach storage disk**. 

![Alt text](https://fptcloud.com/wp-content/uploads/2025/03/Block-Storage-6.png)
...
![Alt text](https://fptcloud.com/wp-content/uploads/2025/03/Block-Storage-7.png)

**2.** Review the confirmation popup, then click **Detach** to confirm. 

![Alt text](https://fptcloud.com/wp-content/uploads/2025/03/Block-Storage-8.png)
...
![Alt text](https://fptcloud.com/wp-content/uploads/2025/03/Block-Storage-9.png)
...
![Alt text](https://fptcloud.com/wp-content/uploads/2025/03/Block-Storage-10.png)

### Create Volume Snapshots

**1.** Select the Storage disk you want to back up from the list, then click **Actions > Create volume snapshots**. 

![Alt text](https://fptcloud.com/wp-content/uploads/2025/03/Block-Storage-11.png)
...
![Alt text](https://fptcloud.com/wp-content/uploads/2025/03/Block-Storage-12.png)
...
![Alt text](https://fptcloud.com/wp-content/uploads/2025/03/Block-Storage-13.png)

**2.** Review the warning message in the confirmation pop-up and click **Delete storage disk** to confirm. 

![Alt text](https://fptcloud.com/wp-content/uploads/2025/03/Block-Storage-14.png)
